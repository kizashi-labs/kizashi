...
func (f *fakeSender) IsolateEndpoint(_ context.Context, agentID, _, _, commandID string) error {
	if f.err != nil {
		return f.err
	}
...
func (r *fakeRecorder) Record(_ context.Context, _, _, status, _ string, details interface{}) (string, error) {
	r.n++
