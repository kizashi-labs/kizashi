...
対象:
  ...
  frontend/tests/lib/route-scan.ts                   （その走査。describe は持ちません）
  frontend/tests/lib/mock-scan.ts                    （MOCK_* が本番に出ていないか）
...
CASES = [
    ...
    # ── 告知の逆向き ───────────────────────────────────────────────────────
    (BP, '  const ANNOUNCED_BUT_ALIVE_CEILING = 17',
    ...
    # ── 作り物の数値 ───────────────────────────────────────────────────────
    (FD, 'const RANDOM_VALUE_CEILING = 29', 'const RANDOM_VALUE_CEILING = 100',
     'Math.random() の上限を上げる'),
    (FD, 'const RANDOM_VALUE_CEILING = 29', 'const RANDOM_VALUE_CEILING = 5',
