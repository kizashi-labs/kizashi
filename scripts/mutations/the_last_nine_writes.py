...
# 資産重要度の経路は 2026-08 の案C移設で routes_noncore.go 側にある
RN = 'server/internal/api/routes_noncore.go'
...
HANDLER_CASES = [
    ...
    # ── 一覧の経路と、画面が読む項目 ─────────────────────────────────────
    (RN, '\t\t\tep.GET("/criticality", s.handlers.AssetCriticality.List)\n', '',
...
BF_CASES = [
    (BF, '\tbackgroundFailedCount = 83', '\tbackgroundFailedCount = 500',
