...
export const PARTIAL_PENDING_ROUTES = new Set<string>([
  '/agents/[id]/processes',  // 1/3 (GET /api/v1/process-rules/agent/:p)
  '/alerts/[id]',  // 3/10 (GET /api/v1/alerts/:p/timeline など)
  '/dashboard',  // 11/19 (soc-metrics / incidents / compliance などの集計タイル)
  '/endpoints/[id]',  // 3/22 (GET /api/v1/agents/:p/process-tree など)
  '/profile',  // 3/12 (GET /api/v1/api-keys など)
  '/login',  // SSO の一覧のみ (GET /api/v1/auth/sso/providers)
