    ...
    <>
      ...
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div className="relative w-full max-w-lg bg-[#0d1220] rounded-2xl border border-[#1e2d42] shadow-2xl overflow-hidden">
          ...
          {/* 上部カラーバー */}
          <div className="h-1 bg-gradient-to-r from-[#e8002d] via-[#ff6b35] to-[#1a6bff]" />
          ...
          <div className="px-6 py-6">
            <div className="flex items-center gap-4 mb-5">
              <div className="w-12 h-12 rounded-xl bg-[#e8002d]/15 border border-[#e8002d]/30 flex items-center justify-center flex-shrink-0">
            ...
            {current.action && (
              <Link
                ...
                onClick={complete}
                className="flex items-center gap-2 w-full px-4 py-2.5 bg-[#1d2f4a] hover:bg-[#253d5e]
          ...
          <div className="flex items-center justify-between px-6 pb-5">
            <button
              ...
              disabled={step === 0}
              className="flex items-center gap-1.5 px-3 py-2 text-sm text-[#3d5068] hover:text-white
