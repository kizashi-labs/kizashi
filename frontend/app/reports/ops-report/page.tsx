          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="bg-[#070d19] border border-[#1e2d42] rounded px-2 py-1 text-xs text-[#e2e8f4] focus:outline-none"
              />
            ...
            <div className="ml-auto flex items-center gap-2">
              <button
                ...
                disabled={generating}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#1e2d42] hover:bg-[#2a3d5a] text-[#e2e8f4] text-xs font-medium transition-colors disabled:opacity-50"
              >
        ...
        <div className="print-area max-w-5xl mx-auto p-8">
          ...
          <div className="mb-12 border-b border-[#1e2d42] pb-10">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 rounded bg-[#e8002d]/20 flex items-center justify-center">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              {[
                ...
                <div key={label} className="bg-[#0d1220] border border-[#1e2d42] rounded p-3">
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={label} className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5 flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-[#1e2d42] flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5 space-y-3">
                {data.recommendations.map((rec, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#e8002d]/20 text-[#e8002d] text-xs font-bold flex items-center justify-center">
                      {i + 1}
                    </span>
