      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg shadow-2xl">
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              rows={2}
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-white placeholder-[#3d5068] focus:outline-hidden focus:border-[#e8002d]/60 resize-none"
              placeholder="リスクの説明..."
                ...
                <div className="space-y-1.5">
                  {[5, 4, 3, 2, 1].map(imp => (
                    <div key={imp} className="flex items-center gap-1.5">
                      <span className="w-4 text-center text-xs text-[#7d92b0] font-medium shrink-0">{imp}</span>
              ...
              {top5.map((risk, idx) => {
                ...
                return (
                  <div key={risk.id} className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <span className="w-5 h-5 rounded-full bg-[#1e2d42] flex items-center justify-center text-[10px] font-bold text-[#7d92b0] shrink-0">
                        {idx + 1}
                      </span>
