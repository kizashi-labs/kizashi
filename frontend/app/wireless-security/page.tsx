                        ...
                        <td className="px-4 py-3">
                          {!net.is_authorized && (
                            <button
                              ...
                              className="flex items-center gap-1.5 px-3 py-1.5 bg-green-600/20 hover:bg-green-600/30 text-green-300 text-xs rounded-sm border border-green-600/30 transition-colors"
                            >
          ...
          <div className="bg-falcon-surface border border-falcon-border rounded-xl p-6 w-full max-w-sm shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-sm text-sm font-medium transition-colors"
              >
                承認する
              </button>
            </div>
