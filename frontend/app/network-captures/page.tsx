        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              required
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2.5 text-[#e2e8f4] text-sm focus:outline-hidden focus:border-[#e8002d]/50 focus:ring-1 focus:ring-[#e8002d]/20"
            >
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2.5 text-[#e2e8f4] text-sm placeholder-[#3d5068] focus:outline-hidden focus:border-[#e8002d]/50 focus:ring-1 focus:ring-[#e8002d]/20"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2.5 text-[#e2e8f4] text-sm font-mono placeholder-[#3d5068] focus:outline-hidden focus:border-[#e8002d]/50 focus:ring-1 focus:ring-[#e8002d]/20"
            />
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2.5 rounded-lg border border-[#1e2d42] text-[#7d92b0] hover:text-white hover:border-[#7d92b0]/40 transition-all text-sm font-medium"
            >
              キャンセル
            </button>
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-[#e8002d] hover:bg-[#c0001f] disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold transition-all"
            >
              {isSubmitting ? (
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl shadow-2xl w-full max-w-sm mx-4">
        <div className="p-6 text-center">
          ...
          <div className="flex gap-3">
            <button
              onClick={onCancel}
              className="flex-1 px-4 py-2.5 rounded-lg border border-[#1e2d42] text-[#7d92b0] hover:text-white transition-all text-sm font-medium"
            >
              キャンセル
            </button>
            <button
              onClick={onConfirm}
              disabled={isDeleting}
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white text-sm font-semibold transition-all"
            >
  ...
  return (
    <div className="min-h-screen bg-[#070d19] p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#e8002d] hover:bg-[#c0001f] text-white text-sm font-semibold transition-all"
          >
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-4 mb-4">
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <select
            ...
            className="bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-1.5 text-sm text-[#e2e8f4] focus:outline-hidden focus:border-[#e8002d]/50"
          >
                ...
                {filteredCaptures.map(capture => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <Network className="w-4 h-4 text-[#3d5068] shrink-0" />
                        <div>
                    ...
                    <td className="px-4 py-3">
                      {capture.filter ? (
                        <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-sm bg-[#1e2d42] text-[#7d92b0] text-xs font-mono">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {(capture.status === 'running' || capture.status === 'pending') && (
                          <button
                            ...
                            title="キャプチャを停止"
                            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-yellow-500/10 hover:bg-yellow-500/20 border border-yellow-500/30 text-yellow-400 text-xs font-medium transition-all disabled:opacity-50"
                          >
                        ...
                        {capture.status === 'completed' && (
                          <button
                            ...
                            title="PCAPをダウンロード"
                            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 text-blue-400 text-xs font-medium transition-all"
                          >
                        ...
                        <button
                          ...
                          title="削除"
                          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 text-red-400 text-xs font-medium transition-all opacity-0 group-hover:opacity-100"
                        >
      ...
      {startMutation.isError && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-4 py-3 rounded-xl bg-red-900/80 border border-red-500/40 text-red-200 text-sm shadow-xl">
