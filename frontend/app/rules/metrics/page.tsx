    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#111827] rounded-2xl border border-[#1e2d42] w-full max-w-2xl shadow-2xl">
        ...
        <div className="px-6 py-4 border-t border-[#1e2d42] flex justify-end">
          <button
            onClick={onClose}
            className="px-5 py-2 bg-[#161f33] text-[#8899aa] rounded-lg hover:bg-[#1d2f4a]
                      ...
                      <td className="px-4 py-3 text-center">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg
                                     bg-[#1a6bff]/10 border border-[#1a6bff]/30 text-[#5a99ff]
                                     hover:bg-[#1a6bff]/20 transition-colors
