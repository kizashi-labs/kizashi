            ...
            <div className="bg-[#111827] rounded-xl p-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#080c14] text-white px-3 py-2 rounded-lg border border-[#1e2d42] focus:outline-hidden focus:border-[#1a6bff] text-sm"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1"
                  />
                  <span className={`text-sm font-bold px-2 py-1 rounded-sm ${
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#080c14] text-white px-3 py-2 rounded-lg border border-[#1e2d42] focus:outline-hidden focus:border-[#1a6bff] text-sm resize-none"
                />
              </div>
            </div>
            ...
            <div className="bg-[#111827] rounded-xl p-4 space-y-3">
              ...
              <div className="flex flex-wrap gap-1.5">
                {(form.mitre_tags || []).map(tag => (
                  <span
                    key={tag}
                    className="text-xs bg-[#161f33] text-[#8899aa] px-2 py-1 rounded-sm font-mono flex items-center gap-1 cursor-pointer hover:bg-red-900/30 hover:text-red-300"
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-[#080c14] text-white px-2 py-1 rounded-sm border border-[#1e2d42] text-xs focus:outline-hidden focus:border-[#1a6bff] font-mono"
                  onKeyDown={e => {
          ...
          <div className="col-span-2">
            <div className="bg-[#111827] rounded-xl h-full flex flex-col">
              ...
              <textarea
                ...
                className="flex-1 bg-[#080c14] text-[#e2e8f4] p-4 font-mono text-sm focus:outline-hidden resize-none rounded-b-xl"
      ...
      {activeTab === 'test' && (
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-4">
            {!form.id && (
              <div className="flex items-center gap-2 text-yellow-400 text-sm bg-yellow-900/20 border border-yellow-700/50 rounded-lg px-4 py-3">
            ...
            <div className="bg-[#111827] rounded-xl p-4">
              ...
              <textarea
                ...
                rows={15}
                className="w-full bg-[#080c14] text-[#e2e8f4] px-3 py-2 rounded-lg border border-[#1e2d42] focus:outline-hidden focus:border-yellow-500 text-sm font-mono resize-none"
              />
              <button
