    ...
    <Link href={item.link} className="block group">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-3.5 hover:border-[#2a3f60] hover:bg-[#111827] transition-all">
        <div className="flex items-start gap-2.5">
          <TypeIcon className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color }} />
          ...
          <ExternalLink className="w-3.5 h-3.5 text-[#3d5068] flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity mt-0.5" />
        </div>
      </div>
    </Link>
  )
