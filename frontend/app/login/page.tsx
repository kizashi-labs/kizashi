        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <div className="space-y-3 w-full max-w-xs">
            {[
              ...
              <div key={item.label}
                   className="flex items-center gap-3 px-4 py-3 rounded bg-[#161f33]/60 border border-[#1e2d42]">
              ...
              <form onSubmit={handleMFASubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0d1220] border border-[#1e2d42] text-white rounded px-4 py-3
                               text-center tracking-[0.6em] font-mono text-lg
                               focus:outline-none focus:border-[#e8002d] focus:ring-1 focus:ring-[#e8002d]/30
                  ...
                  {ssoProviders.map(provider => (
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-2.5 mb-2
                                 bg-[#0d1220] border border-[#1e3a5f] text-[#4a9eff] rounded
                                 hover:bg-[#161f33] hover:border-[#4a9eff]/40 transition-colors text-sm font-medium"
                    >
                      <Shield className="w-4 h-4" />
