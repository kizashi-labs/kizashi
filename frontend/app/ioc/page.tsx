    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 text-sm bg-[#161f33] text-[#e2e8f4]
                       rounded-lg hover:bg-[#1d2f4a] transition-colors border border-[#1e2d42]
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-8 pr-4 py-2 text-sm border border-[#1e2d42] rounded-lg
                         bg-[#080c14] text-white placeholder-[#5a6a7a]
                         focus:outline-none focus:border-orange-500 font-mono"
            />
          </div>
          <button
      ...
      {showImport && (
        <div className="mb-6 bg-[#111827] rounded-xl border border-[#1e2d42] p-4 space-y-3">
          ...
          {/* Format help */}
          <div className="text-[10px] text-[#5a6a7a] bg-[#080c14]/60 rounded p-2 font-mono leading-5 border border-[#1e2d42]">
          ...
          <div className="flex gap-3 items-end flex-wrap">
            <div>
              ...
              <select
                ...
                className="text-sm bg-[#080c14] border border-[#1e2d42] rounded px-2 py-1.5
                           text-[#e2e8f4] focus:outline-none focus:border-orange-500"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-16 text-sm bg-[#080c14] border border-[#1e2d42] rounded px-2 py-1.5
                           text-[#e2e8f4] focus:outline-none focus:border-orange-500"
              />
            </div>
          </div>
          ...
          {importMode === 'text' ? (
            <textarea
              ...
              rows={8}
              className="w-full text-xs bg-[#080c14] border border-[#1e2d42] rounded-lg px-3 py-2
                         text-[#e2e8f4] placeholder-gray-700 font-mono focus:outline-none focus:border-orange-500
                         resize-y"
            />
          ) : (
            <div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div>
              ...
              <select
                ...
                className="w-full text-sm bg-[#080c14] border border-[#1e2d42] rounded-lg px-3 py-2
                           text-[#e2e8f4] focus:outline-none focus:border-orange-500"
              >
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full text-sm bg-[#080c14] border border-[#1e2d42] rounded-lg px-3 py-2
                           text-[#e2e8f4] placeholder-[#5a6a7a] focus:outline-none focus:border-orange-500"
              />
            </div>
            <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-8 pr-3 py-1.5 text-sm border border-[#1e2d42] rounded-lg
                       bg-[#111827] text-white placeholder-[#5a6a7a] w-48
