...
function ProgressBar({ value }: { value: number }) {
  return (
    <div className="w-full h-2 bg-[#1a2540] rounded-full overflow-hidden">
      <div
        className="h-full bg-gradient-to-r from-[#1a6bff] to-[#5a99ff] rounded-full transition-all duration-300"
    ...
    <div className="min-h-screen bg-[#080c14] p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          <Link
            href="/ioc"
            className="flex items-center gap-1.5 text-sm text-[#7d92b0] hover:text-[#e2e8f4]
                       transition-colors px-3 py-1.5 rounded-lg hover:bg-[#111827]"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
            {[
              ...
              <div key={item.col} className="flex items-start gap-2">
                <code className="text-[#a78bfa] font-mono flex-shrink-0">{item.col}</code>
                {item.req && (
                  <span className="text-red-400 text-[10px] flex-shrink-0 mt-px">必須</span>
                )}
            ...
            <div className="flex flex-col gap-3">
              <label className="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  className="w-4 h-4 rounded border-[#2a3a5c] bg-[#080c14] text-[#1a6bff]
                             accent-[#1a6bff] cursor-pointer"
                />
                <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full text-sm bg-[#080c14] border border-[#1e2d42] rounded-lg
                             px-3 py-2 text-[#e2e8f4] focus:outline-none focus:border-orange-500
                             [color-scheme:dark]"
                />
              </div>
