      ...
      {indicators.map(ind => (
        <div key={ind.type} className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-4">
          <div className="flex items-start justify-between mb-2">
            <span className={`text-xs px-2 py-0.5 rounded ${EVENT_TYPE_COLORS[ind.type]}`}>{ind.label}</span>
    ...
    <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <select
          ...
          className="bg-[#070d19] border border-[#1e2d42] rounded px-2 py-1 text-white text-xs focus:outline-none focus:border-[#e8002d]/50"
        >
      ...
      {selectedUser && (
        <>
          <div className="flex items-center gap-4 text-xs mb-4">
            <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-[#e8002d]/60 inline-block" />選択ユーザー: {selectedUser.name}</span>
            <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-blue-500/60 inline-block" />部門平均 ({selectedUser.department})</span>
          </div>
            ...
            {userEventTypes.map(type => {
              ...
              return (
                <div key={type}>
                  ...
                  <div className="relative h-4 bg-[#1e2d42] rounded overflow-hidden">
                    <div className="absolute left-0 top-0.5 h-1.5 rounded bg-[#e8002d]/60 transition-all" style={{ width: `${userPct}%` }} />
                    <div className="absolute left-0 bottom-0.5 h-1.5 rounded bg-blue-500/60 transition-all" style={{ width: `${avgPct}%` }} />
                  </div>
                </div>
              )
            })}
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-white text-xs focus:outline-none focus:border-[#e8002d]/50"
              />
              <button onClick={addIndicator} className="px-3 py-2 bg-[#1e2d42] text-[#7d92b0] rounded text-xs hover:text-white transition-colors">追加</button>
            </div>
          </div>
          <div>
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                className="w-full bg-[#0d1220] border border-[#1e2d42] rounded px-3 py-2 pl-9 text-white text-sm
                    ...
                    <tr key={user.id} className="hover:bg-[#111827] transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-wrap gap-1">
                          {user.risk_indicators.slice(0, 2).map(ind => (
                            <span key={ind} className="text-[10px] px-1.5 py-0.5 rounded bg-[#e8002d]/10 text-[#e8002d]/80 border border-[#e8002d]/20">
                              {ind}
                            </span>
                          ))}
                      ...
                      <td className="px-4 py-3">
                        <button
                          ...
                          className="text-xs px-3 py-1.5 rounded bg-[#e8002d]/10 text-[#e8002d] border border-[#e8002d]/30
                                     hover:bg-[#e8002d]/20 transition-colors whitespace-nowrap"
                        >
                          調査開始
                        </button>
                      </td>
                ...
                <div className="flex items-center justify-between px-5 py-3 border-b border-[#1e2d42]">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="検索..."
                      className="bg-[#070d19] border border-[#1e2d42] rounded px-3 py-1.5 pl-8 text-white text-xs focus:outline-none focus:border-[#e8002d]/50 w-48"
                    />
                  </div>
                </div>
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                              ...
                              <span className={`text-[10px] px-1.5 py-0.5 rounded ${EVENT_TYPE_COLORS[event.event_type]}`}>
                          ...
                          <div className="flex-shrink-0 flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-xs px-2 py-1 rounded bg-[#1e2d42] text-[#7d92b0] hover:text-white transition-colors whitespace-nowrap"
                            >
                              詳細
                            </button>
                          </div>
                ...
                <tbody className="divide-y divide-[#1e2d42]">
                  {investigations.filter(i => i.status !== 'closed').map(inv => (
                    <tr key={inv.id} className="hover:bg-[#111827] transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <button className="text-xs px-3 py-1.5 rounded bg-[#1e2d42] text-[#7d92b0] hover:text-white transition-colors">
                          続行
                        </button>
                      </td>
                    </tr>
