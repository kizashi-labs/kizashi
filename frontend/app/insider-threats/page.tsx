  ...
  return (
    <div className="overflow-x-auto">
      ...
      <div className="flex items-center gap-4 mt-2 text-xs text-[#7d92b0]">
        ...
        <span className="flex items-center gap-1">
          <span className="w-3 h-3 rounded-xs bg-[#1e2d42] inline-block border border-[#1e2d42]" /> 非アクティブ
        </span>
      </div>
    </div>
  )
...
export default function InsiderThreatsPage() {
  ...
  const behavior = behaviorData ?? (selectedUserId ? mockOr(MOCK_USER_BEHAVIOR, null) : null)
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 bg-[#0d1220] border border-[#1e2d42] rounded-sm text-sm text-white placeholder-[#7d92b0] focus:outline-hidden focus:border-[#7d92b0]/50 w-48"
              />
            </div>
            <select
                          ...
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="flex flex-col items-end gap-2 shrink-0">
                              ...
                              <Link
                                ...
                                className="flex items-center gap-1 px-3 py-1.5 bg-[#1d2f4a] hover:bg-[#243a5e] text-white text-xs rounded-sm transition-colors"
                              >
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="px-3 py-2 bg-[#0d1220] border border-[#1e2d42] rounded-sm text-sm text-white focus:outline-hidden focus:border-[#7d92b0]/50 w-72"
            >
            ...
            {riskUsers.map((user, index) => (
              <div key={user.id} className="px-5 py-4 flex items-center gap-5 hover:bg-[#0d1830]/40 transition-colors">
                ...
                <div className="flex items-center gap-3 w-48 shrink-0">
                  <div className="w-9 h-9 rounded-full bg-linear-to-br from-[#1a6bff] to-[#0044cc] flex items-center justify-center text-white font-bold text-sm shrink-0">
                    {user.full_name[0]}
                  </div>
                ...
                {/* Last Anomaly */}
                <div className="text-xs text-[#7d92b0] w-28 shrink-0 text-right">
                  <p>最終異常:</p>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1d2f4a] hover:bg-[#243a5e] text-white text-xs rounded-sm transition-colors shrink-0"
                >
