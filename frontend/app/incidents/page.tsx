...
function KanbanCard({ incident, onDragStart, onClick }: KanbanCardProps) {
  return (
    <div
      ...
      onClick={onClick}
      className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-3 cursor-grab active:cursor-grabbing
    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-2 flex-wrap">
        <span className={`text-[10px] px-1.5 py-0.5 rounded font-semibold ${severityBadgeStyle(incident.severity)}`}>
      ...
      <div className="space-y-1">
        {incident.assigned_to_name && (
          <div className="flex items-center gap-1.5 text-[11px] text-[#7d92b0]">
            <span className="w-4 h-4 rounded-full bg-[#1e2d42] flex items-center justify-center text-[9px] font-bold text-white flex-shrink-0">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 bg-[#0d1220] border border-[#1e2d42]
                         hover:bg-[#1d2f4a] text-[#7d92b0] text-sm rounded-lg transition-colors"
              title="更新"
            >
              <RefreshCw size={14} />
              更新
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 bg-[#0d1220] border border-[#1e2d42]
                         hover:bg-[#1d2f4a] text-[#7d92b0] text-sm rounded-lg transition-colors disabled:opacity-40"
            >
              <Download size={14} />
              CSV
            </button>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#161f33] border border-[#1e2d42] rounded px-3 py-2 text-sm text-white
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#161f33] border border-[#1e2d42] rounded px-3 py-2 text-sm h-20 resize-none text-white
                             focus:outline-none focus:border-[#e8002d]"
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-8 pr-3 py-1.5 text-sm border border-[#1e2d42] rounded-lg
                             bg-[#0d1220] text-white placeholder-[#5a6a7a] w-52
                             focus:outline-none focus:border-[#e8002d]"
                />
              </div>
              {search && (
              ...
              <div className="space-y-3">
                {allListIncidents.map(inc => (
                  ...
                  >
                    ...
                    <ChevronRight size={16} className="text-[#5a6a7a] flex-shrink-0" />
                  </div>
                ))}
              </div>
            )}
            ...
            {(data?.total ?? 0) > 20 && (
              <div className="flex justify-center gap-3 mt-6">
                <button
                  ...
                  className="px-4 py-2 bg-[#0d1220] border border-[#1e2d42] rounded-lg text-sm
                             disabled:opacity-40 hover:bg-[#1d2f4a] text-white"
                >
                  前へ
                </button>
