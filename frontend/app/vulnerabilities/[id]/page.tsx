          ...
          <div className="flex items-start gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-3 mb-1 flex-wrap">
                ...
                <span className={`text-xs font-bold px-2 py-0.5 rounded border ${sev.text} ${sev.bg} ${sev.border}`}>
                  {sev.label}
                </span>
                <span className={`text-xs px-2 py-0.5 rounded border font-medium ${statusCfg.cls}`}>
                  {statusCfg.label}
                </span>
              </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {!confirmDelete ? (
              <button
                ...
                className="p-1.5 text-[#3d5068] hover:text-red-400 transition-colors rounded"
              >
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="px-2 py-1 text-xs bg-red-900/50 hover:bg-red-800 border border-red-700 text-red-300 rounded transition-colors"
                >
                  削除
                </button>
                <button
                  onClick={() => setConfirmDelete(false)}
                  className="px-2 py-1 text-xs bg-[#161f33] hover:bg-[#1d2f4a] border border-[#1e2d42] text-[#8899aa] rounded transition-colors"
                >
                  取消
                </button>
              </div>
        ...
        <div className="rounded-xl border border-[#1e2d42] bg-[#111827] p-5 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#0d1625] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-[#e2e8f4] placeholder-[#3d5068] outline-none focus:border-[#1a6bff] resize-none"
            />
          </div>
