      ...
      >
        ...
        <div className="flex items-start gap-4 p-6 border-b border-[#1e2d42]">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <a href={`/assets/vulnerabilities?cve=${cve.id}`} className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#1a2540] border border-[#1e2d42] text-[#7d92b0] hover:text-white hover:border-[#e8002d] text-sm transition-colors">
              <Eye className="w-3.5 h-3.5" /> 影響資産を確認
            </a>
            <button onClick={onClose} className="p-2 rounded hover:bg-[#1e2d42] text-[#7d92b0] hover:text-white transition-colors">
              <X className="w-5 h-5" />
            </button>
          </div>
        </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {cve.related_cves.map(id => (
                      <span key={id} className="font-mono text-[#e8002d] text-sm bg-red-900/10 border border-red-900/30 rounded px-2 py-1">{id}</span>
                    ))}
                  </div>
                </div>
              )}
            ...
            <div className="space-y-4">
              {cve.affected_products.map((p, i) => (
                <div key={i} className="bg-[#070d19] rounded-lg p-4 border border-[#1e2d42]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {p.versions.map((v, j) => (
                      <span key={j} className="font-mono text-xs bg-[#0a1628] border border-[#1e2d42] text-[#7d92b0] rounded px-2 py-1">{v}</span>
                    ))}
                  </div>
                </div>
              ))}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {cve.exploit_sources.map((url, i) => (
                      <div key={i} className="flex items-center gap-2 bg-[#070d19] border border-[#1e2d42] rounded p-3">
                        <ExternalLink className="w-3.5 h-3.5 text-[#3d5068] flex-shrink-0" />
            ...
            <div className="space-y-3">
              ...
              {cve.mitre_techniques.map((t, i) => (
                <div key={i} className="bg-[#070d19] rounded-lg p-4 border border-[#1e2d42] flex items-center gap-4">
                  <div className="flex-shrink-0 bg-red-900/20 border border-red-900/30 rounded-lg p-3">
        ...
        <div className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg pl-10 pr-4 py-3 text-white placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50 font-mono text-sm transition-colors"
            />
          </div>
          <button
      ...
      <div className="flex gap-1 mb-6 bg-[#0d1220] border border-[#1e2d42] rounded-lg p-1 w-fit">
        {([
          ...
          <button
            ...
            className={`px-4 py-2 rounded text-sm font-medium transition-colors ${activeTab === t.key ? 'bg-[#e8002d] text-white' : 'text-[#7d92b0] hover:text-white'}`}
          >
            {t.label}
          </button>
        ))}
          ...
          <div className="flex flex-wrap gap-3 bg-[#0d1220] border border-[#1e2d42] rounded-xl p-4">
            <div className="relative">
              ...
              <input
                ...
                className="bg-[#070d19] border border-[#1e2d42] rounded-lg pl-9 pr-4 py-2 text-white placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50 text-sm w-56 transition-colors"
              />
            </div>
            <select
              value={filterSeverity}
              onChange={e => setFilterSeverity(e.target.value as Severity | 'all')}
              className="bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-[#7d92b0] text-sm focus:outline-none focus:border-[#e8002d]/50"
            >
      ...
      {activeTab === 'queue' && (
        <div className="space-y-4">
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-4">
            <div className="flex items-center gap-3">
              <Shield className="w-4 h-4 text-[#e8002d] flex-shrink-0" />
              <p className="text-[#7d92b0] text-sm">
                優先度スコア計算式:
                <span className="ml-2 font-mono text-white bg-[#070d19] border border-[#1e2d42] rounded px-3 py-1">
                  ...
                  {m(MOCK_PRIORITY_QUEUE).map(item => {
                    ...
                    return (
                      <tr key={item.cve_id} className="hover:bg-[#0a1628] transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <button className="px-3 py-1.5 bg-[#e8002d]/10 border border-[#e8002d]/30 text-[#e8002d] hover:bg-[#e8002d]/20 rounded text-xs font-medium transition-colors whitespace-nowrap">
                            修復タスク作成
                          </button>
                        </td>
                      </tr>
