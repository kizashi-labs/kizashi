      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-[#8899aa] leading-relaxed">
          ...
          <Section title="第4条（ライセンスおよび料金）">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong className="text-[#e2e8f4]">Lite プラン</strong>：¥500/エンドポイント/月（5〜45エンドポイント・5台刻み）</li>
              <li><strong className="text-[#e2e8f4]">Starter プラン</strong>：¥1,000/エンドポイント/月（30〜199エンドポイント・10台刻み）</li>
              <li><strong className="text-[#e2e8f4]">Professional プラン</strong>：¥2,800/エンドポイント/月（200〜999エンドポイント）</li>
