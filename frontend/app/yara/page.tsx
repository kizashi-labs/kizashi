    ...
    <div className="relative">
      <div className="flex items-center gap-1">
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 bg-[#161f33] hover:bg-[#1d2f4a] border border-[#1e2d42] text-[#7d92b0] hover:text-white text-sm rounded-lg transition-colors disabled:opacity-50"
        >
        ...
        <button
          ...
          className="px-2 py-2 bg-[#161f33] hover:bg-[#1d2f4a] border border-[#1e2d42] text-[#3d5068] hover:text-white text-xs rounded-lg transition-colors"
          title="スキャンジョブ一覧"
        >
      ...
      {showJobs && (
        <div className="absolute top-10 right-0 z-50 bg-[#0d1220] border border-[#1e2d42] rounded-xl shadow-2xl w-96 max-h-80 overflow-auto">
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#0d1220] rounded-2xl w-full max-w-3xl border border-[#1e2d42] flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="flex items-start justify-between p-6 border-b border-[#1e2d42] shrink-0">
          <div className="flex items-start gap-3 min-w-0">
            <div className="w-9 h-9 rounded-lg bg-[#e8002d]/15 border border-[#e8002d]/30 flex items-center justify-center shrink-0 mt-0.5">
          ...
          <button
            onClick={onClose}
            className="text-[#7d92b0] hover:text-white transition-colors shrink-0 ml-4"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          <div className="bg-[#070d19] rounded-xl border border-[#1e2d42] p-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-white placeholder-[#3d5068] font-mono focus:outline-hidden focus:border-[#e8002d]/50"
              />
              <button
                onClick={() => { if (testInput.trim()) testMutation.mutate(testInput.trim()) }}
                disabled={!testInput.trim() || testMutation.isPending}
                className="flex items-center gap-1.5 px-4 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white text-sm rounded-lg disabled:opacity-50 transition-colors"
              >
        ...
        {/* Footer */}
        <div className="flex justify-end px-6 py-4 border-t border-[#1e2d42] shrink-0">
          <button
            onClick={onClose}
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#0d1220] rounded-2xl w-full max-w-2xl border border-[#1e2d42] flex flex-col max-h-[92vh]">
        ...
        <div className="overflow-y-auto p-6 space-y-4 flex-1">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#070d19] text-white px-3 py-2 rounded-lg border border-[#1e2d42] focus:outline-hidden focus:border-[#e8002d]/50 text-sm placeholder-[#3d5068]"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-[#070d19] text-white px-3 py-2 rounded-lg border border-[#1e2d42] focus:outline-hidden focus:border-[#e8002d]/50 text-sm"
              >
                {CATEGORIES.map(c => (
          ...
          <div className="flex items-center gap-3">
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              >
                <div className={`absolute top-0.5 w-4 h-4 rounded-full bg-[#e2e8f4] shadow-sm transition-transform ${
          ...
          <div>
            ...
            <textarea
              ...
              rows={14}
              spellCheck={false}
              className="w-full bg-[#070d19] text-[#a8c0e0] px-3 py-2.5 rounded-lg border border-[#1e2d42] focus:outline-hidden focus:border-[#e8002d]/50 text-xs font-mono resize-y leading-relaxed"
            />
            {contentWarning && (
        ...
        {/* Footer */}
        <div className="flex gap-3 px-6 py-4 border-t border-[#1e2d42] shrink-0">
          <button
            onClick={() => mutation.mutate(form)}
            disabled={!canSubmit || mutation.isPending}
            className="flex-1 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm font-medium transition-colors"
          >
            {mutation.isPending
              ? <Loader2 className="w-4 h-4 animate-spin" />
      ...
      <div className="bg-[#0d1220] rounded-2xl w-full max-w-md border border-[#1e2d42] p-6">
        ...
        <div className="flex gap-3">
          <button
            onClick={onConfirm}
            disabled={isPending}
            className="flex-1 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white rounded-lg disabled:opacity-50 text-sm font-medium transition-colors flex items-center justify-center gap-2"
          >
      ...
      <div className="flex items-start justify-between">
        ...
        {canWrite && (
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={openCreate}
              className="flex items-center gap-2 px-4 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white text-sm font-medium rounded-lg transition-colors"
            >
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative flex-1 min-w-48 max-w-72">
          ...
          <input
            ...
            className="w-full bg-[#0d1220] text-white pl-9 pr-8 py-2 rounded-lg border border-[#1e2d42] focus:outline-hidden focus:border-[#e8002d]/40 text-sm placeholder-[#3d5068]"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          <Filter className="w-3.5 h-3.5 text-[#3d5068] shrink-0" />
          <button
            onClick={() => setCategory('')}
        ...
        {(search || categoryFilter || severityFilter) && (
          <button
            ...
            className="flex items-center gap-1 text-xs text-[#7d92b0] hover:text-white px-2 py-1 rounded-lg hover:bg-[#161f33] transition-colors"
          >
            <X className="w-3.5 h-3.5" />
            フィルターをクリア
          </button>
