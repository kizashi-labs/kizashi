    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-md shadow-2xl">
        ...
        <div className="flex gap-3 px-5 py-4 border-t border-[#1e2d42]">
          <button onClick={onClose} className="flex-1 px-4 py-2 border border-[#1e2d42] text-[#7d92b0] rounded hover:text-white text-sm">
            キャンセル
          </button>
          <button
            onClick={() => mutation.mutate()}
            disabled={mutation.isPending}
            className="flex-1 px-4 py-2 bg-[#e8002d] hover:bg-[#c0001e] text-white rounded text-sm font-medium flex items-center justify-center gap-2 disabled:opacity-50"
          >
          ...
          <div className="space-y-2 text-sm">
            {[
              ...
              <div key={label as string} className="flex justify-between gap-4">
                <span className="text-[#7d92b0] flex-shrink-0">{label as string}</span>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {asset.open_ports.map(port => (
              <span key={port} className="font-mono text-xs bg-[#070d19] border border-[#1e2d42] px-2 py-1 rounded text-[#7d92b0]">
                {port}
              </span>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {asset.services.map(svc => (
              <span key={svc} className="text-xs bg-blue-500/10 text-blue-300 border border-blue-500/20 px-2 py-1 rounded">
                {svc}
              </span>
            ))}
          </div>
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-md shadow-2xl">
        ...
        <div className="p-5 space-y-5">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 bg-[#070d19] border rounded text-sm text-white placeholder-[#3d5068] focus:outline-none font-mono ${
        ...
        <div className="flex gap-3 px-5 py-4 border-t border-[#1e2d42]">
          ...
          <button
            ...
            disabled={mutation.isPending}
            className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded text-sm font-medium flex items-center justify-center gap-2 disabled:opacity-50"
          >
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 bg-[#0d1220] border border-[#1e2d42] rounded text-sm text-white placeholder-[#7d92b0] focus:outline-none focus:border-[#7d92b0]/50 w-56"
              />
            </div>
            <select
              value={managedFilter}
                    ...
                    return (
                      ...
                      >
                        <td className="px-4 py-3">
                          <span className="font-mono text-xs text-white bg-[#070d19] px-2 py-0.5 rounded">
                            {asset.ip_address}
                          </span>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex flex-wrap gap-1 max-w-[120px]">
                            {visiblePorts.map(p => (
                              <span key={p} className="font-mono text-[10px] bg-[#070d19] text-[#7d92b0] border border-[#1e2d42] px-1.5 py-0.5 rounded">
                                {p}
                              </span>
                            ))}
                          ...
                          <div className="flex items-center gap-2 justify-end">
                            {!asset.is_managed && (
                              <button
                                ...
                                className="px-2 py-1 bg-[#1d2f4a] hover:bg-[#243a5e] text-white text-xs rounded transition-colors whitespace-nowrap"
                              >
                                管理対象にする
                              </button>
                            )}
                            <button
                              ...
                              className="px-2 py-1 border border-[#1e2d42] hover:border-[#7d92b0]/40 text-[#7d92b0] hover:text-white text-xs rounded transition-colors"
                            >
                              詳細
                            </button>
                          </div>
