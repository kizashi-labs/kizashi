          ...
          <div>
            ...
            {form.recurring && (
              <select
                ...
                className="mt-2 w-full bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-2 text-sm text-white focus:outline-hidden focus:border-[#4a6fa5]"
              >
        ...
        {cells.map((day, i) => {
          ...
          return (
            <div
              ...
              className={`h-16 p-1 rounded-sm cursor-pointer transition-colors border
                ${isSelected
          ...
          <div className="flex-1">
            <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-4 mb-4">
              ...
              <div className="flex items-center justify-between mb-4">
                <button
                  onClick={prevMonth}
                  className="p-2 text-[#7d92b0] hover:text-white hover:bg-[#1e2d42] rounded-sm transition-colors"
                >
                ...
                {selectedDayEvents.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {selectedDayEvents.map(ev => (
                      <div key={ev.id} className="flex items-center justify-between p-3 bg-[#070d19] rounded-sm border border-[#1e2d42]">
                        <div>
              ...
              {thisMonthEvents.length === 0 ? (
                ...
                <div className="space-y-2 max-h-[600px] overflow-y-auto">
                  {thisMonthEvents
                    ...
                    .map(ev => (
                      <div key={ev.id} className="p-2.5 bg-[#070d19] rounded-sm border border-[#1e2d42]">
                      ...
                      <tr key={ev.id} className="border-b border-[#1e2d42] hover:bg-[#070d19] transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1">
                            <button className="p-1.5 text-[#7d92b0] hover:text-white hover:bg-[#1e2d42] rounded-sm transition-colors" title="編集">
                              <Edit2 className="w-3.5 h-3.5" />
                            </button>
                            {ev.status !== 'completed' && (
                              <button
                                onClick={() => completeMut.mutate(ev.id)}
                                className="p-1.5 text-[#7d92b0] hover:text-green-400 hover:bg-green-400/10 rounded-sm transition-colors"
                                title="完了にする"
                              >
