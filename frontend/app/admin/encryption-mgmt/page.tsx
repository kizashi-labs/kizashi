                  ...
                  {policies.map(p => (
                    <tr key={p.id} className="border-b border-[#1e2d42]/50 hover:bg-[#131d31]/50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs px-2 py-0.5 rounded border ${encTypeCls[p.type]}`}>
                          {p.type.replace('_', ' ')}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-[#7d92b0] font-mono text-xs">{p.algorithm}</td>
                      <td className="px-4 py-3">
                        <span className={`text-xs px-2 py-0.5 rounded border capitalize ${p.mode === 'enforce' ? 'bg-red-900/40 text-red-300 border-red-700/50' : p.mode === 'monitor' ? 'bg-yellow-900/40 text-yellow-300 border-yellow-700/50' : 'bg-gray-700/40 text-gray-400 border-gray-600/50'}`}>
                          {p.mode}
                        </span>
                      </td>
                ...
                <tbody>
                  {filteredEndpoints.map(e => (
                    <tr key={e.id} className={`border-b border-[#1e2d42]/50 hover:bg-[#131d31]/50 transition-colors ${selected.has(e.id) ? 'bg-[#131d31]/70' : ''}`}>
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs px-2 py-0.5 rounded border ${statusCls[e.status]}`}>
          ...
          <div className="flex items-center gap-12">
            ...
            <div className="space-y-3 flex-1">
              ...
              <div className="border-t border-[#1e2d42] pt-3 flex items-center gap-3">
                <span className="w-3 h-3 rounded-full flex-shrink-0 bg-[#1e2d42]" />
