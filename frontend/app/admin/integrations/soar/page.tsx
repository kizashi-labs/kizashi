...
function SelectInput({
  ...
  return (
    <select
      ...
      onChange={e => onChange(e.target.value)}
      disabled={disabled}
      className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2.5 text-sm text-[#e2e8f4] focus:outline-hidden focus:border-[#e8002d]/60 focus:ring-1 focus:ring-[#e8002d]/20 disabled:opacity-40 disabled:cursor-not-allowed transition-colors appearance-none"
    >
      {options.map(o => (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 bg-[#e8002d]/5 border border-[#e8002d]/20 rounded-xl px-5 py-4">
        <Info className="w-4 h-4 text-[#e8002d] shrink-0 mt-0.5" />
                ...
                <td className="px-5 py-3">
                  {action.status === 'failed' ? (
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-[#070d19] border border-[#1e2d42] text-[#7d92b0] hover:border-[#e8002d]/40 hover:text-[#e2e8f4] disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                    >
