                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-1">
                        {(rule.conditions.severity_match ?? []).map(sev => (
                          <span
                            key={sev}
                            className={`px-1.5 py-0.5 rounded text-[10px] font-medium border ${severityColor[sev] ?? 'text-[#7d92b0] border-[#1e2d42] bg-[#1e2d42]'}`}
                          >
                            {sev}
                          </span>
                        ))}
                        {(rule.conditions.rule_id_match ?? []).map(rid => (
                          <span key={rid} className="px-1.5 py-0.5 rounded text-[10px] font-medium border border-[#1e2d42] bg-[#1e2d42] text-[#7d92b0]">
                            {rid}
                          </span>
                        ))}
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-28 bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-[#e8002d]/50"
                />
              </div>
