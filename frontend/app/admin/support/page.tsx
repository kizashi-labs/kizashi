    ...
    <div className="mt-4 pt-4 border-t border-[#1e2d42]">
      ...
      <div className="space-y-2 mb-3 max-h-48 overflow-y-auto">
        {comments.map(cm => (
          <div key={cm.id} className={`flex gap-2 ${cm.is_internal ? 'opacity-70' : ''}`}>
            ...
            <div className={`flex-1 rounded-sm p-2 border ${cm.is_internal ? 'bg-[#1a1000] border-[#f59e0b]/20' : 'bg-[#080c14] border-[#1e2d42]'}`}>
      ...
      <div className="space-y-2">
        <textarea
          ...
          rows={2}
          placeholder="返信を入力..."
          className="w-full bg-[#080c14] border border-[#1e2d42] rounded-sm px-3 py-2 text-xs text-[#e2e8f4] placeholder-[#5a6a7a] focus:outline-hidden focus:border-[#2a3f5a] resize-none"
        />
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-[#1e2d42] hover:bg-[#2a3f5a] disabled:opacity-50 text-[#e2e8f4] text-xs rounded-sm transition-colors"
          >
            送信
          </button>
        </div>
  ...
  return (
    <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg overflow-hidden">
      ...
      >
        ...
        {/* 優先度バッジ */}
        <span className={`px-1.5 py-0.5 rounded-sm text-[10px] font-medium shrink-0 ${priorityBadge[ticket.priority] ?? 'bg-[#1e2d42] text-[#8899aa]'}`}>
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            <div>
              ...
              <select
                ...
                className="bg-[#080c14] border border-[#1e2d42] rounded-sm px-2 py-1.5 text-xs text-[#e2e8f4] focus:outline-hidden"
              >
    ...
    <div className="p-6">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <select
          ...
          className="ml-auto bg-[#0d1220] border border-[#1e2d42] rounded-sm px-2 py-1.5 text-xs text-[#e2e8f4] focus:outline-hidden"
        >
