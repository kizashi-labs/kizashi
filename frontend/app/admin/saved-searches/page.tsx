    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-[#0d1220] border border-[#1e2d42] rounded-xl shadow-2xl">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white
                         text-sm placeholder-[#3d5275] font-mono focus:outline-none focus:border-[#1a6bff]
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white
                           text-sm appearance-none focus:outline-none focus:border-[#1a6bff] transition-colors pr-8"
              >
          ...
          <div className="flex items-center justify-between py-2">
            ...
            >
              <span className={`absolute top-0.5 w-4 h-4 bg-[#e2e8f4] rounded-full shadow transition-transform
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-[#1e2d42]">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm text-[#7d92b0] hover:text-white border border-[#1e2d42]
          ...
          <button
            ...
            className="px-4 py-2 text-sm text-white bg-[#1a6bff] hover:bg-[#1558e0] rounded-lg
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-[#0d1220] border border-[#1e2d42] rounded-xl shadow-2xl p-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-full bg-[#e8002d]/15 flex items-center justify-center flex-shrink-0">
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-[#1a6bff]/15 border border-[#1a6bff]/30
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => refetch()}
              className="p-2 text-[#7d92b0] hover:text-white border border-[#1e2d42] hover:border-[#2d4060]
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#1a6bff] hover:bg-[#1558e0] text-white
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full bg-[#0d1220] border border-[#1e2d42] rounded-lg pl-9 pr-3 py-2 text-white
                         text-sm placeholder-[#3d5275] focus:outline-none focus:border-[#1a6bff] transition-colors"
            />
          </div>
          <div className="relative">
            ...
            <select
              ...
              className="bg-[#0d1220] border border-[#1e2d42] rounded-lg pl-9 pr-8 py-2 text-white
                         text-sm appearance-none focus:outline-none focus:border-[#1a6bff] transition-colors"
            >
          ...
          {(nameFilter || categoryFilter) && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-sm text-[#7d92b0] hover:text-white
                    ...
                    >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex items-center gap-1.5">
                          <User className="w-3.5 h-3.5 text-[#7d92b0] flex-shrink-0" />
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex items-center gap-1">
                          <button
                            onClick={() => handleRun(s)}
                            title="実行"
                            className="p-1.5 text-[#7d92b0] hover:text-green-400 hover:bg-green-900/20
                                       rounded-lg transition-colors"
                          >
                          ...
                          <button
                            ...
                            title="編集"
                            className="p-1.5 text-[#7d92b0] hover:text-[#1a6bff] hover:bg-[#1a6bff]/10
                                       rounded-lg transition-colors"
                          >
                          ...
                          <button
                            ...
                            title="削除"
                            className="p-1.5 text-[#7d92b0] hover:text-[#e8002d] hover:bg-[#e8002d]/10
                                       rounded-lg transition-colors"
                          >
