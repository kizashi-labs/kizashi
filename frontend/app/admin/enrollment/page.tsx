    ...
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg w-full max-w-md">
        ...
        <div className="p-5 space-y-4">
          <div className="p-3 rounded bg-[#070d19] border border-[#1e2d42]">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded bg-[#070d19] border border-[#1e2d42] text-white text-sm placeholder-[#3d5068] focus:outline-none focus:border-red-500/50 resize-none"
            />
          </div>
          <div className="flex gap-2 justify-end">
            ...
            <button
              ...
              disabled={!reason}
              className="px-4 py-2 rounded text-sm bg-red-600 text-white hover:bg-red-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              拒否する
            </button>
          </div>
        ...
        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-none focus:border-[#e8002d]/50"
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded bg-[#070d19] border border-[#1e2d42] text-white text-sm font-mono placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50"
            />
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <select
              ...
              className="px-3 py-1.5 rounded bg-[#0d1220] border border-[#1e2d42] text-[#7d92b0] text-sm focus:outline-none focus:border-[#e8002d]/50"
            >
            ...
            {selectedIds.size > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded text-sm bg-green-600 text-white hover:bg-green-700 transition-colors ml-auto"
              >
                  ...
                  {displayRequests.map(req => {
                    ...
                    return (
                      <tr key={req.id} className="border-b border-[#1e2d42]/50 hover:bg-[#0d1825] transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <span className={`px-2 py-0.5 rounded text-xs border ${os.color}`}>{os.label}</span>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3">
                          {req.auto_approved ? (
                            <span className="px-2 py-0.5 rounded text-xs bg-blue-500/15 border border-blue-500/25 text-blue-400">自動</span>
                          ) : (
                            <span className="px-2 py-0.5 rounded text-xs bg-[#1e2d42] border border-[#2a3f5c] text-[#3d5068]">手動</span>
                          )}
                        </td>
                        <td className="px-4 py-3">
                          <span className={`px-2 py-0.5 rounded text-xs border ${st.color}`}>{st.label}</span>
                        </td>
                        <td className="px-4 py-3">
                          {isPending && (
                            <div className="flex items-center gap-1.5">
                              <button
                                ...
                                className="flex items-center gap-1 px-2.5 py-1 rounded text-xs bg-green-600/20 border border-green-600/30 text-green-400 hover:bg-green-600/30 transition-colors"
                              >
                              ...
                              <button
                                ...
                                className="flex items-center gap-1 px-2.5 py-1 rounded text-xs bg-red-600/20 border border-red-600/30 text-red-400 hover:bg-red-600/30 transition-colors"
                              >
                                <X className="w-3 h-3" />
                                拒否
                              </button>
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded text-sm bg-[#e8002d] text-white hover:bg-[#c00025] transition-colors mb-4"
            >
            ...
            {preToken && (
              <div className="space-y-3">
                <div className="flex items-center gap-2 p-3 rounded bg-[#070d19] border border-[#1e2d42]">
                ...
                {curlCommand && (
                  <div>
                    ...
                    <div className="relative">
                      <pre className="text-xs text-[#a8c0d6] font-mono bg-[#070d19] border border-[#1e2d42] rounded p-3 pr-10 overflow-x-auto whitespace-pre">
                        {curlCommand}
                      </pre>
                      <button
                        onClick={() => handleCopy(curlCommand, 'curl')}
                        className="absolute top-2 right-2 p-1.5 rounded hover:bg-[#1e2d42] text-[#7d92b0] hover:text-white transition-colors"
                      >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          ...
                          <span className={`px-2 py-0.5 rounded text-xs border ${act.color}`}>{act.label}</span>
                          <span className="px-2 py-0.5 rounded text-xs bg-[#1e2d42] border border-[#2a3f5c] text-[#7d92b0]">
                            優先度 {rule.priority}
                          </span>
                          <span className="px-2 py-0.5 rounded text-xs bg-[#1e2d42] border border-[#2a3f5c] text-[#7d92b0]">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <ArrowRight className="w-3 h-3 text-[#3d5068] flex-shrink-0" />
                          <code className="text-xs font-mono text-[#a8c0d6] bg-[#070d19] border border-[#1e2d42] px-2 py-0.5 rounded">
                            {rule.match_pattern}
                          </code>
                        </div>
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {rule.assign_tags.map(tag => (
                            <span key={tag} className="px-1.5 py-0.5 rounded text-[10px] bg-[#1e2d42] text-[#7d92b0]">
                              {tag}
                            </span>
                          ))}
                        </div>
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded hover:bg-red-500/10 text-[#7d92b0] hover:text-red-400 transition-colors"
                        >
            ...
            {testerResult !== null && (
              <div className="mt-3">
                {testerResult === 'no-match' ? (
                  <div className="flex items-center gap-2 p-3 rounded bg-[#1e2d42] border border-[#2a3f5c]">
                  ...
                  <div className={`flex items-start gap-3 p-3 rounded border ${
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#7d92b0] mt-1">
                        アクション: <span className={`${ACTION_LABELS[testerResult.action].color} px-1.5 py-0.5 rounded border text-xs`}>
