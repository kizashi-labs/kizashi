...
export default function NetworkTopologyPage() {
  ...
  const { data: stats = { total_nodes: 0, endpoints: 0, servers: 0, critical_nodes: 0, total_edges: 0 }, isLoading: statsLoading } = useQuery<TopologyStats>({
    queryKey: ['network-topology-stats'],
    queryFn: () => apiFetch<TopologyStats>('/api/v1/admin/network-topology/stats'),
  })

  const { data: topology = { nodes: [], edges: [] }, isLoading: topoLoading } = useQuery<TopologyData>({
    queryKey: ['network-topology'],
    queryFn: () => apiFetch<TopologyData>('/api/v1/admin/network-topology'),
  })
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm font-mono focus:outline-hidden focus:border-[#e8002d]"
                />
              </div>
              <div>
