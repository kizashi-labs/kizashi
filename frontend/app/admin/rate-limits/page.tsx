        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm font-mono placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50"
            />
          </div>
                ...
                {rules.map(rule => (
                  <tr key={rule.id} className="hover:bg-[#19253d]/40 transition-colors">
                    ...
                    <td className="px-5 py-3.5">
                      <code className="text-[#7d92b0] text-xs bg-[#070d19] px-2 py-0.5 rounded font-mono">
                    ...
                    <td className="px-5 py-3.5 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-1.5 text-[#7d92b0] hover:text-white hover:bg-[#1e2d42] rounded transition-colors"
                          title="編集"
                        >
