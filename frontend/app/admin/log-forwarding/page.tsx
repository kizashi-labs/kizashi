...
function ToggleSwitch({ checked, onChange, label }: { checked: boolean; onChange: (v: boolean) => void; label: string }) {
  return (
    <label className="flex items-center gap-3 cursor-pointer select-none">
      ...
      >
        <span className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-[#e2e8f4] shadow transition-transform duration-200 ${checked ? 'translate-x-5' : 'translate-x-0'}`} />
      </div>
  ...
  return (
    <input
      ...
      className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-[#e2e8f4] placeholder-[#3d5068]
                 focus:outline-none focus:border-[#1a6bff]/60 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
    />
  )
}
  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        onClick={run}
        disabled={loading}
        className="flex items-center gap-2 px-4 py-2 rounded bg-[#1e2d42] hover:bg-[#253750] text-[#7d92b0] hover:text-[#e2e8f4]
                   text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed border border-[#1e2d42]"
      >
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#e8002d] hover:bg-[#c8001d]
        ...
        <div className="flex justify-end pb-8">
          <button
            onClick={() => saveMutation.mutate()}
            disabled={saveMutation.isPending}
            className="flex items-center gap-2 px-6 py-3 rounded-lg bg-[#e8002d] hover:bg-[#c8001d]
