...
export default function ProcessAllowlistPage() {
  ...
  const toggleMutation = useMutation({
    mutationFn: (id: string) =>
      // サーバの toggle は PATCH です。PUT はどこにも当たりません。
              ...
              <tbody className="divide-y divide-[#1e2d42]">
                {rules.map(rule => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm text-xs font-medium bg-[#1e2d42] text-[#7d92b0] border border-[#1e2d42]">
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="p-1 rounded-sm transition-colors hover:bg-[#1e2d42]"
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg mx-4 shadow-2xl max-h-[90vh] flex flex-col">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full appearance-none bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-2 text-sm text-white focus:outline-hidden focus:border-[#e8002d]/50 pr-8"
                    >
            ...
            <div className="flex justify-end gap-3 px-5 py-4 border-t border-[#1e2d42] shrink-0">
              <button
