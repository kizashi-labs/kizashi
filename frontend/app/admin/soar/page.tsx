        ...
        <div className="px-6 py-4 space-y-6">
          ...
          <div>
            ...
            {form.trigger_type === 'schedule' && (
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-white font-mono focus:outline-none focus:border-[#4a6fa5]"
            ...
            {form.trigger_type === 'webhook' && (
              <div>
                ...
                <div className="bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-[#7d92b0] font-mono">
          ...
          <div>
            ...
            {form.actions.length === 0 && (
              <div className="text-center py-6 border border-dashed border-[#1e2d42] rounded text-[#3d5068] text-sm">
                アクションを追加してください
              </div>
            )}
            <div className="space-y-3">
              {form.actions.map((action, idx) => {
                ...
                return (
                  <div key={action.id} className="border border-[#1e2d42] rounded p-3 bg-[#070d19]">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <select
                        ...
                        className="flex-1 bg-[#0d1220] border border-[#1e2d42] rounded px-2 py-1.5 text-sm text-white focus:outline-none focus:border-[#4a6fa5]"
                      >
                    ...
                    {action.type === 'create_ticket' && (
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-[#0d1220] border border-[#1e2d42] rounded px-2 py-1.5 text-sm text-white focus:outline-none focus:border-[#4a6fa5]"
                        >
                          <option value="critical">クリティカル</option>
                          <option value="high">高</option>
                          <option value="medium">中</option>
                    ...
                    {action.type === 'send_notification' && (
                      <div>
                        ...
                        <textarea
                          ...
                          rows={2}
                          className="w-full bg-[#0d1220] border border-[#1e2d42] rounded px-2 py-1.5 text-sm text-white focus:outline-none focus:border-[#4a6fa5] resize-none"
                          placeholder="通知メッセージ"
                        />
                      </div>
                    )}
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg w-full max-w-md p-6" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2 text-sm bg-[#e8002d] hover:bg-[#c0001f] text-white rounded flex items-center gap-2 transition-colors"
          >
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg w-full max-w-lg" onClick={e => e.stopPropagation()}>
        ...
        <div className="px-6 py-4">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4 text-xs">
            <div className="bg-[#070d19] rounded p-2 text-center">
          ...
          <div className="space-y-2">
            {exec.steps.map((step, i) => (
              <div key={i} className="flex items-start gap-3 p-3 bg-[#070d19] rounded border border-[#1e2d42]">
...
export default function SoarPage() {
  ...
  const statusBadge = (status: ExecStatus) => {
    if (status === 'running') return (
      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-xs bg-blue-500/20 text-blue-400">
        <Loader2 className="w-3 h-3 animate-spin" />実行中
      </span>
    )
    if (status === 'completed') return (
      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-xs bg-green-500/20 text-green-400">
        <CheckCircle className="w-3 h-3" />完了
      </span>
    )
    return (
      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-xs bg-[#e8002d]/20 text-[#e8002d]">
            ...
            <div key={wf.id} className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className={`px-2 py-0.5 rounded text-xs font-medium ${TRIGGER_COLORS[wf.trigger_type]}`}>
                ...
                <div className="flex items-center gap-2 ml-4 flex-shrink-0">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 rounded transition-colors"
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded transition-colors ${wf.enabled ? 'text-green-400 hover:bg-green-400/10' : 'text-[#3d5068] hover:bg-[#1e2d42]'}`}
                  ...
                  <button className="p-1.5 text-[#7d92b0] hover:text-white hover:bg-[#1e2d42] rounded transition-colors">
              ...
              <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-[#1e2d42]">
                {wf.actions.map((action, i) => {
                  const Icon = ACTION_ICONS[action.type]
                  return (
                    <span key={i} className="inline-flex items-center gap-1 px-2 py-1 bg-[#070d19] rounded text-xs text-[#7d92b0]">
                ...
                {filteredExecs.map(exec => (
                  <tr key={exec.id} className="border-b border-[#1e2d42] hover:bg-[#070d19] transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className="text-xs text-[#7d92b0] font-mono bg-[#070d19] px-2 py-0.5 rounded">
                        {exec.trigger}
                      </span>
                    </td>
