                  ...
                  {(assetsData?.assets ?? []).map((asset) => (
                    <tr key={asset.id} className="border-b border-[#1e2d42] last:border-0 hover:bg-[#111827]">
                      ...
                      <td className="px-4 py-3">
                        <span className={`px-2 py-0.5 rounded text-xs font-medium capitalize ${TYPE_BADGE[asset.type]}`}>
                          {asset.type}
                        </span>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        {asset.alert_on_access ? (
                          <span className="px-2 py-0.5 rounded text-xs bg-green-500/20 text-green-400">Yes</span>
                        ) : (
                          <span className="px-2 py-0.5 rounded text-xs bg-gray-500/20 text-[#7d92b0]">No</span>
                        )}
                      </td>
                ...
                <tbody>
                  {(eventsData?.events ?? []).map((ev) => (
                    <tr key={ev.id} className="border-b border-[#1e2d42] last:border-0 hover:bg-[#111827]">
                      ...
                      <td className="px-4 py-3">
                        <span className="px-2 py-0.5 rounded text-xs bg-orange-500/20 text-orange-400">{ev.event_type}</span>
                      </td>
                      <td className="px-4 py-3">
                        {ev.alert_generated ? (
                          <span className="px-2 py-0.5 rounded text-xs bg-red-500/20 text-red-400">Yes</span>
                        ) : (
                          <span className="px-2 py-0.5 rounded text-xs bg-gray-500/20 text-[#7d92b0]">No</span>
                        )}
                      </td>
