      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg max-h-[85vh] overflow-y-auto">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/50"
              />
              <button className="flex items-center gap-1.5 px-3 py-2 bg-[#161f33] border border-[#1e2d42] rounded-sm text-[#7d92b0] text-sm hover:text-white hover:border-[#7d92b0]/40 transition-colors">
        ...
        <div className="flex justify-end gap-3 p-5 border-t border-[#1e2d42]">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm bg-[#e8002d] text-white rounded-sm font-medium hover:bg-[#c5001f] transition-colors"
          >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {control.frameworks.map(f => (
                <span key={f} className="text-xs px-2.5 py-1 rounded-sm bg-[#161f33] text-[#7d92b0] border border-[#1e2d42] font-mono">{f}</span>
              ))}
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {FRAMEWORKS.map(f => (
                <button
                  ...
                  className={`text-xs px-3 py-1.5 rounded-sm font-mono font-medium transition-colors border ${
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-4 mb-4">
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <select
            ...
            className="bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-2 text-sm text-[#7d92b0] focus:outline-hidden focus:border-[#e8002d]/50"
          >
                    ...
                    <tr key={control.id} className="hover:bg-[#111827] transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-wrap gap-1">
                          {control.frameworks.map(f => (
                            <span key={f} className="text-[10px] px-1.5 py-0.5 rounded-sm bg-[#1e2d42] text-[#7d92b0] font-mono">{f}</span>
                          ))}
                        </div>
                      </td>
                      <td className="px-4 py-3">
