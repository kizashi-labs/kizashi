                  ...
                  {rules.map(rule => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-sm text-xs font-medium ${badge.bg} ${badge.text}`}>
                            {badge.label}
                          </span>
                        </td>
                        <td className="px-4 py-3">
              ...
              <div>
                {editingRule && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-blue-400 border border-blue-500/30 rounded-sm hover:bg-blue-500/10 transition-colors disabled:opacity-50"
                  >
