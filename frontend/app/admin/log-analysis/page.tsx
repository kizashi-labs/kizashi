        ...
        <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-green-400 text-sm font-mono focus:outline-hidden focus:border-[#e8002d]/50 resize-none"
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-yellow-300 text-sm font-mono focus:outline-hidden focus:border-[#e8002d]/50 resize-none"
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
...
function RulesTab() {
  ...
  const { data, isLoading } = useQuery<ParseRule[]>({
    ...
    queryFn: () => apiFetchList<ParseRule>('/api/v1/admin/log-analysis/rules'),
  })
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="p-1.5 rounded-sm hover:bg-[#1a6bff]/20 text-[#7d92b0] hover:text-[#1a6bff] transition-colors"
                        title="テスト"
                      >
...
function JobsTab() {
  ...
  const { data, isLoading } = useQuery<AnalysisJob[]>({
    ...
    queryFn: () => apiFetchList<AnalysisJob>('/api/v1/admin/log-analysis/jobs'),
  })
        ...
        <div className="space-y-3">
          <div className="flex gap-3">
            ...
            <select
              ...
              className="bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/50"
            >
          ...
          <div className="flex gap-3">
            <textarea
              ...
              rows={2}
              className="flex-1 bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-green-400 text-sm font-mono focus:outline-hidden focus:border-[#e8002d]/50 resize-none"
