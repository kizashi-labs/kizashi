                ...
                <div key={trap.id} className="bg-falcon-surface border border-falcon-border rounded-xl p-5 hover:border-[#2a3f5a] transition-colors">
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => handleSimulate(trap)}
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-900/30 border border-blue-700/30 text-blue-300 rounded-sm text-xs hover:bg-blue-900/50 transition-colors">
                      <Play className="w-3 h-3" /> テスト実行
                    </button>
                    <button onClick={() => setDeleteTarget(trap)}
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-red-900/20 border border-red-700/30 text-red-400 rounded-sm text-xs hover:bg-red-900/40 transition-colors ml-auto">
