                ...
                {tabEntries.map(entry => (
                  <tr key={entry.id} className="hover:bg-[#0a1628] transition-colors">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <span
                          className={`inline-block px-1.5 py-0.5 rounded text-[10px] font-medium border uppercase ${HASH_TYPE_COLORS[entry.hash_type]}`}
                        >
                          {entry.hash_type}
                        </span>
                        <button
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-2 py-1 rounded text-xs text-[#7d92b0] hover:text-white hover:bg-[#1e2d42] transition-colors"
                        title="VirusTotalで検索"
                      >
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg mx-4 shadow-2xl">
            ...
            <div className="px-5 py-4 space-y-4">
              <p className="text-xs text-[#7d92b0]">
                形式: <code className="font-mono bg-[#070d19] px-1 py-0.5 rounded text-[#e2e8f4]">hash_value,hash_type,file_name</code>（hash_type・file_name は任意）
              </p>
              <textarea
                value={bulkCsv}
