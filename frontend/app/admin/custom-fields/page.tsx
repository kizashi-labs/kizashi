              ...
              <tbody className="divide-y divide-[#1e2d42]">
                {sortedFields.map((field, idx) => (
                  <tr key={field.id} className="hover:bg-[#0a1628] transition-colors">
                    ...
                    {/* field_name */}
                    <td className="px-4 py-3">
                      <span className="text-xs font-mono text-[#e2e8f4] bg-[#070d19] px-2 py-0.5 rounded border border-[#1e2d42]">
                        {field.field_name}
                      </span>
                    </td>
                    ...
                    {/* field_type */}
                    <td className="px-4 py-3">
                      <span className="text-xs px-2 py-0.5 rounded border bg-[#070d19] border-[#1e2d42] text-[#7d92b0]">
                    ...
                    <td className="px-4 py-3">
                      {field.required ? (
                        <span className="text-xs px-2 py-0.5 rounded bg-[#e8002d]/10 text-[#e8002d] border border-[#e8002d]/20">必須</span>
                      ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <div className="px-5 py-4 space-y-4 overflow-y-auto">
              ...
              {/* entity_type hint */}
              <div className="flex items-center gap-2 px-3 py-2 rounded bg-[#070d19] border border-[#1e2d42] text-xs text-[#7d92b0]">
              ...
              {form.field_type === 'select' && (
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    placeholder={"low\nmedium\nhigh\ncritical"}
                    className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-white font-mono placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50 resize-none"
                  />
                </div>
              )}
