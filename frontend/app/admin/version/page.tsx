        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-6">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-14 h-14 rounded-xl bg-linear-to-br from-[#e8002d] to-[#a80020] flex items-center justify-center shadow-lg">
                <PackageCheck className="w-7 h-7 text-white" />
              </div>
              <div>
                <p className="text-[#7d92b0] text-xs uppercase tracking-wider mb-1">現在のバージョン</p>
                {isLoading ? (
                  <div className="h-8 w-24 bg-[#1e2d42] rounded-sm animate-pulse" />
                ) : (
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl">
            <div className="px-5 py-4 border-b border-[#1e2d42] flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                {critical > 0 && (
                  <span className="text-xs text-[#e8002d] bg-[#e8002d]/10 border border-[#e8002d]/20 px-2 py-0.5 rounded-sm">
                    緊急 {critical}
                  </span>
                )}
              </div>
                    ...
                    <tr key={comp.name} className="hover:bg-[#19253d]/40 transition-colors">
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-2.5">
                          <comp.icon className="w-4 h-4 text-[#3d5068] shrink-0" />
                      ...
                      <td className="px-5 py-3.5">
                        <code className={`font-mono text-xs px-2 py-0.5 rounded-sm ${
            ...
            <div className="px-5 py-2">
              {isLoading ? (
                <div className="space-y-3 py-2">
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} className="h-10 bg-[#1e2d42] rounded-sm animate-pulse" />
                  ))}
                </div>
              ) : (
                <>
