  ...
  const AgentSelect = ({
    ...
    <div className="relative">
      <select
        ...
        className={`appearance-none bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-[#e8002d]/50 pr-8 ${className ?? ''}`}
      >
        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-white placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50 w-48"
            />
          </div>
          <button
            onClick={() => handleAddTag(quickAgent, quickTag)}
            disabled={addTagMutation.isPending}
            className="px-4 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white text-sm font-medium rounded transition-colors disabled:opacity-50"
          >
                  ...
                  <>
                    <tr key={tag} className="hover:bg-[#0a1628] transition-colors">
                      <td className="px-4 py-3">
                        <span className="inline-block px-2 py-0.5 rounded text-xs font-medium bg-[#e8002d]/10 text-[#e8002d] border border-[#e8002d]/20">
                          {tag}
                        </span>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        <button
                          ...
                          className="flex items-center gap-1.5 text-xs text-[#7d92b0] hover:text-white transition-colors px-2 py-1 rounded hover:bg-[#1e2d42]"
                        >
                        ...
                        <td colSpan={3} className="px-6 py-4">
                          ...
                          <div className="flex flex-wrap gap-2 items-end">
                            ...
                            <button
                              ...
                              disabled={addTagMutation.isPending}
                              className="px-3 py-2 bg-[#1e2d42] hover:bg-[#e8002d] text-white text-xs font-medium rounded transition-colors disabled:opacity-50"
                            >
                              追加
                            </button>
                          </div>
