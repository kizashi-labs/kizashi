  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex border-b border-[#1e2d42] shrink-0 px-6">
          ...
          {section === 'basic' ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="text" value={form.name}
                  ...
                  className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/50 placeholder:text-[#3d5068]"
              ...
              <div>
                ...
                <textarea value={form.description}
                  ...
                  className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/50 placeholder:text-[#3d5068] resize-none"
            ...
            <div className="space-y-3">
              ...
              {form.steps.map((step, idx) => (
                ...
                <div key={step.id} className="bg-[#070d19] border border-[#1e2d42] rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <GripVertical className="w-4 h-4 text-[#3d5068] cursor-grab shrink-0" />

                    <span className="w-6 h-6 rounded-full bg-[#1e2d42] text-[#7d92b0] text-xs flex items-center justify-center font-bold shrink-0">
                    ...
                    <input type="text" value={step.title}
                      ...
                      className="flex-1 bg-[#0d1220] border border-[#1e2d42] rounded-sm px-2 py-1.5 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/50 placeholder:text-[#3d5068]" />

                    <button onClick={() => removeStep(idx)}

                      className="text-[#7d92b0] hover:text-red-400 transition-colors shrink-0">
                  ...
                  <textarea value={step.description}
                    ...
                    className="w-full bg-[#0d1220] border border-[#1e2d42] rounded-sm px-2 py-1.5 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/50 placeholder:text-[#3d5068] resize-none mb-3" />
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <select value={step.type}
                      ...
                      className="bg-[#0d1220] border border-[#1e2d42] rounded-sm px-2 py-1.5 text-white text-xs focus:outline-hidden focus:border-[#e8002d]/50">
              ...
              <button onClick={addStep}
                ...
                className="w-full py-3 border border-dashed border-[#1e2d42] rounded-lg text-[#7d92b0] hover:border-[#e8002d]/50 hover:text-white transition-colors flex items-center justify-center gap-2 text-sm">
...
export default function PlaybooksPage() {
  ...
  const { data: playbooks = [] } = useQuery<Playbook[], Error, Playbook[]>({
    ...
    queryFn: (): Promise<Playbook[]> => apiFetch('/api/v1/playbooks') as Promise<Playbook[]>,
  ...
  const { data: executions = [] } = useQuery<ExecutionRecord[], Error, ExecutionRecord[]>({
    ...
    queryFn: (): Promise<ExecutionRecord[]> => apiFetch('/api/v1/playbooks/executions') as Promise<ExecutionRecord[]>,
  ...
  const deleteMutation = useMutation({
    ...
    mutationFn: (id: string) =>
      ...
      apiFetch(`/api/v1/playbooks/${id}`, { method: 'DELETE' }),
              ...
              <div key={pb.id}
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => setExecuteTarget(pb)}
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-green-700/20 hover:bg-green-700/40 border border-green-700/50 text-green-300 rounded-lg text-xs font-medium transition-colors">
                  ...
                  <button onClick={() => setEditTarget(pb)}
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#161f33] hover:bg-[#19253d] border border-[#1e2d42] text-[#7d92b0] hover:text-white rounded-lg text-xs font-medium transition-colors">
                  ...
                  <button onClick={() => deleteMutation.mutate(pb.id)}
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-red-900/20 hover:bg-red-900/40 border border-red-700/50 text-red-400 rounded-lg text-xs font-medium transition-colors">
          ...
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <select value={statusFilter} onChange={e => setStatusFilter(e.target.value)}
                ...
                className="bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-1.5 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/50">
