            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="bg-[#0d1220] border border-[#1e2d42] rounded-lg pl-3 pr-8 py-2 text-sm text-white focus:outline-none focus:border-[#e8002d]/60 appearance-none cursor-pointer"
                >
                ...
                <tbody>
                  {displayEvents.map(evt => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs px-2 py-0.5 rounded border capitalize ${eventTypeBadge(evt.event_type)}`}>
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs px-2 py-0.5 rounded border capitalize ${actionBadge(evt.action_taken)}`}>
                          {evt.action_taken}
                        </span>
                      </td>
                      <td className="px-4 py-3">
                ...
                <tbody>
                  {displayPolicies.map(pol => (
                    <tr key={pol.id} className="border-b border-[#1e2d42]/50 hover:bg-[#131d31]/50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs px-2 py-0.5 rounded border capitalize ${policyTypeBadge(pol.type)}`}>
                          {pol.type}
                        </span>
                      </td>
                      <td className="px-4 py-3">
