...
function ConditionRow({
  ...
  return (
    <div className="flex items-center gap-2 p-2 bg-[#070d19] rounded border border-[#1e2d42]">
      <span className="text-xs text-[#3d5068] w-4 text-center flex-shrink-0">{index + 1}</span>
      ...
      <div className="relative flex-1 min-w-0">
        <select
          ...
          className="w-full bg-[#0d1220] border border-[#1e2d42] rounded px-2 py-1.5
                     text-xs text-[#e2e8f4] appearance-none pr-6
      ...
      <input
        ...
        placeholder="値を入力..."
        className="flex-1 min-w-0 bg-[#0d1220] border border-[#1e2d42] rounded px-2 py-1.5
                   text-xs text-[#e2e8f4] placeholder-[#3d5068]
                   focus:outline-none focus:border-[#e8002d]/50"
      />
      ...
      <button
        ...
        disabled={!canRemove}
        className="p-1 rounded text-[#7d92b0] hover:text-[#e8002d] hover:bg-[#e8002d]/10
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 space-y-5">
            ...
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded text-xs
                           bg-[#1e2d42] hover:bg-[#e8002d]/10 text-[#7d92b0] hover:text-[#e8002d]
                           border border-[#1e2d42] hover:border-[#e8002d]/30 transition-all"
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className={`text-xs font-bold px-2 py-0.5 rounded border ${sevLevel.bg} ${sevLevel.color}`}>
            ...
            <input
              ...
              className="w-full h-2 rounded-lg appearance-none cursor-pointer
                         bg-gradient-to-r from-green-500 via-yellow-500 via-orange-500 to-[#e8002d]"
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2
                         text-sm text-[#e2e8f4] placeholder-[#3d5068] font-mono
                         focus:outline-none focus:border-[#e8002d]/50"
            />
            <p className="text-xs text-[#3d5068] mt-1">
        ...
        {/* Modal footer */}
        <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-[#1e2d42] flex-shrink-0">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm text-[#7d92b0] hover:text-white rounded
                       border border-[#1e2d42] hover:border-[#7d92b0]/40 transition-colors"
          >
            キャンセル
          </button>
          <button
            ...
            className="px-5 py-2 text-sm bg-[#e8002d] hover:bg-[#c8001f] text-white rounded
    ...
    <div className="min-h-screen bg-[#070d19] p-6">
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded bg-[#e8002d] hover:bg-[#c8001f]
        ...
        {isLoading ? (
          <div className="p-8 text-center">
            <div className="space-y-3 max-w-full">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="h-12 bg-[#0a1628] rounded animate-pulse" />
              ))}
            </div>
          </div>
        ) : isError ? (
                ...
                {rules.map(rule => {
                  ...
                  return (
                    <tr key={rule.id} className="hover:bg-[#0a1628] transition-colors">
                          ...
                          {rule.mitre_tags.length > 0 && (
                            <div className="flex gap-1 flex-wrap">
                              {rule.mitre_tags.slice(0, 3).map(tag => (
                                <span key={tag} className="text-[10px] px-1.5 py-0.5 rounded bg-purple-500/10 text-purple-400 border border-purple-500/20 font-mono">
                                  {tag}
                                </span>
                              ))}
                      ...
                      {/* Event Type */}
                      <td className="px-4 py-3">
                        <span className={`inline-block px-2 py-0.5 rounded text-xs font-medium border ${EVENT_TYPE_COLORS[rule.event_type]}`}>
                      ...
                      {/* Severity */}
                      <td className="px-4 py-3">
                        <span className={`inline-block px-2 py-0.5 rounded text-xs font-bold border ${sevLevel.bg} ${sevLevel.color}`}>
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-sm mx-4 shadow-2xl p-5">
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-sm text-[#7d92b0] hover:text-white rounded
                           border border-[#1e2d42] transition-colors"
              >
                キャンセル
              </button>
              <button
                ...
                className="px-4 py-2 text-sm bg-[#e8002d] hover:bg-[#c8001f] text-white rounded
