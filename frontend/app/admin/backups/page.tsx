          ...
          <div className="space-y-3">
            ...
            {backups.length === 0 ? (
              ...
              <div className="space-y-2 max-h-52 overflow-y-auto pr-1">
                {backups.map((b) => (
                  ...
                  >
                    <Database className={`w-4 h-4 shrink-0 ${selected === b.name ? 'text-[#e8002d]' : 'text-[#7d92b0]'}`} />
                    ...
                    {selected === b.name && <CheckCircle className="w-4 h-4 text-[#e8002d] shrink-0" />}
                  </button>
                ))}
              </div>
            )}
            <div className="flex justify-end pt-2">
              <button
                onClick={() => setStep(1)}
                disabled={!selected}
                className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium disabled:opacity-40"
              >
        ...
        {step === 1 && (
          <div className="space-y-3">
            ...
            {([ ['full', 'フル復元', '全スキーマとデータを復元します'], ['schema', 'スキーマのみ', 'テーブル定義・インデックスのみ復元します'], ['data', 'データのみ', 'スキーマはそのまま、データ行のみ復元します'] ] as [RestoreScope, string, string][]).map(([val, label, desc]) => (
              ...
              >
                <Shield className={`w-4 h-4 mt-0.5 shrink-0 ${scope === val ? 'text-[#e8002d]' : 'text-[#7d92b0]'}`} />
                <div>
                  <p className="text-sm text-white font-medium">{label}</p>
                  <p className="text-xs text-[#7d92b0] mt-0.5">{desc}</p>
                </div>
                {scope === val && <CheckCircle className="w-4 h-4 text-[#e8002d] ml-auto shrink-0" />}
              </button>
            ))}
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#e8002d] text-white rounded-lg hover:bg-[#c0001f] transition-colors text-sm font-medium disabled:opacity-50"
          >
                    ...
                    <tr key={backup.name} className="border-b border-[#1e2d42]/50 last:border-0 hover:bg-[#1e2d42]/20 transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <Database className="w-3.5 h-3.5 text-[#7d92b0] shrink-0" />
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs bg-blue-900/30 text-blue-400 border border-blue-700/40 hover:bg-blue-900/50 transition-colors"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs bg-purple-900/30 text-purple-400 border border-purple-700/40 hover:bg-purple-900/50 transition-colors disabled:opacity-50"
                          >
                            <Shield className="w-3.5 h-3.5" /> 検証
                          </button>
                          <button
                            onClick={() => setDeleteTarget(backup.name)}
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs bg-red-900/30 text-red-400 border border-red-700/40 hover:bg-red-900/50 transition-colors"
                          >
          ...
          <div className="bg-[#0d1220] rounded-xl border border-[#1e2d42] overflow-hidden">
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <span className={`absolute top-0.5 w-5 h-5 bg-[#e2e8f4] rounded-full shadow-sm transition-transform ${autoEnabled ? 'translate-x-6' : 'translate-x-0.5'}`} />
                </button>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-24 px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden focus:border-blue-500 disabled:opacity-40"
                  />
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <span className={`absolute top-0.5 w-5 h-5 bg-[#e2e8f4] rounded-full shadow-sm transition-transform ${autoDeleteEnabled ? 'translate-x-6' : 'translate-x-0.5'}`} />
                </button>
              </div>
          ...
          <div className="p-5 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm placeholder:text-[#3d5068] focus:outline-hidden focus:border-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm placeholder:text-[#3d5068] focus:outline-hidden focus:border-blue-500 font-mono"
                />
              </div>
            ...
            <div className="flex items-center gap-3 pt-1">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#1e2d42] text-[#7d92b0] rounded-lg hover:text-white border border-[#1e2d42] hover:border-[#2e4060] transition-colors text-sm disabled:opacity-50"
              >
          ...
          <div className="bg-[#0d1220] rounded-2xl p-6 w-full max-w-md border border-[#1e2d42] shadow-2xl">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2.5 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2 text-sm font-medium"
              >
              ...
              <button
                ...
                disabled={deleteMutation.isPending}
                className="px-5 py-2.5 bg-[#1e2d42] text-[#7d92b0] rounded-xl hover:bg-[#2e4060] transition-colors text-sm disabled:opacity-50"
              >
                キャンセル
              </button>
            </div>
