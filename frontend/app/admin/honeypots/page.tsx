...
function Toast({ message, onClose }: { message: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-4 py-3 rounded-lg
                    bg-[#0d1220] border border-green-500/40 text-green-300 shadow-xl animate-fade-in">
      ...
      <div className="w-full max-w-lg bg-[#0d1220] border border-[#1e2d42] rounded-xl shadow-2xl">
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-[#e2e8f4] focus:outline-none focus:border-[#1a6bff] transition-colors"
              value={form.name}
          ...
          <div>
            ...
            <textarea
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-[#e2e8f4] focus:outline-none focus:border-[#1a6bff] transition-colors resize-none h-20"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-[#e2e8f4] focus:outline-none focus:border-[#1a6bff]"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-[#e2e8f4] focus:outline-none focus:border-[#1a6bff] font-mono transition-colors"
                  ...
                  {topIPs.length === 0 ? (
                    ...
                    topIPs.map(([ip, count]) => (
                      <div key={ip} className="flex items-center gap-3">
                        <span className="text-base flex-shrink-0">{getCountryFlag(ip)}</span>
                        ...
                        <span className="text-xs font-bold text-[#e8002d] flex-shrink-0">{count}</span>
                      </div>
                    ))
                  )}
