    ...
    <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-5">
      ...
      <div className="flex items-center gap-4 mt-4">
        <div className="flex items-center gap-1.5">
          <div className="w-3 h-3 rounded-sm bg-[#3b82f6] opacity-30" />
                      ...
                      <tr key={item.id} className="border-b border-[#1e2d42]/60 hover:bg-[#070d19]/50 transition-colors">
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-xs border font-medium mr-2 ${CATEGORY_STYLES[item.category].cls}`}>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-end gap-1.5">
                            <button
                              ...
                              className="p-1.5 rounded hover:bg-green-500/10 text-[#7d92b0] hover:text-green-400 transition-colors"
                              title="取引追加"
                            >
