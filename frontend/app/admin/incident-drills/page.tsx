                ...
                <tr key={d.id} className="hover:bg-[#0d1826] transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      {d.status === 'scheduled' && (
                        <button onClick={() => setExecutingDrill(d)} className="flex items-center gap-1 px-2 py-1 bg-green-500/10 text-green-400 border border-green-500/30 rounded-sm text-xs hover:bg-green-500/20 transition-colors">
                          <PlayCircle className="w-3 h-3" />開始
                        </button>
                      )}
                      {d.status === 'completed' && (
                        <button onClick={() => setViewingScorecard(d)} className="flex items-center gap-1 px-2 py-1 bg-blue-500/10 text-blue-400 border border-blue-500/30 rounded-sm text-xs hover:bg-blue-500/20 transition-colors">
