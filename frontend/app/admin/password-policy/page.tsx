  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative h-2 bg-[#1e2d42] rounded-full">
        <div
          className="absolute h-2 bg-gradient-to-r from-blue-600 to-blue-400 rounded-full"
          style={{ width: `${pct}%` }}
        />
        <input
          type="range"
        ...
        />
        <div
          className="absolute top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-blue-400 border-2 border-white shadow pointer-events-none"
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg w-full max-w-sm shadow-2xl">
        ...
        <div className="flex gap-2 px-5 pb-5">
          <button onClick={onCancel}
            className="flex-1 px-4 py-2 rounded text-sm text-[#7d92b0] border border-[#1e2d42] hover:bg-[#1e2d42] transition-colors">
            キャンセル
          </button>
          <button onClick={onConfirm}
            className="flex-1 px-4 py-2 rounded text-sm font-semibold bg-blue-600 hover:bg-blue-700 text-white transition-colors">
            確認
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#070d19] p-6">
      ...
      <div className="flex items-center justify-between bg-[#0d1220] border border-[#1e2d42] rounded-lg px-5 py-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleReset}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs text-[#7d92b0] border border-[#1e2d42]
            ...
            <div className="px-5 py-5 space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 pr-10 text-white text-sm
                             focus:outline-none focus:border-blue-500 placeholder-[#3d5068]"
                />
                <button
              ...
              <div className="border-t border-[#1e2d42] pt-4 space-y-2">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-2">
                    {!testPassword
                      ? <div className="w-3.5 h-3.5 rounded-full border border-[#1e2d42] flex-shrink-0" />
                      : r.ok
                      ? <CheckCircle2 className="w-3.5 h-3.5 text-green-400 flex-shrink-0" />
                      : <XCircle className="w-3.5 h-3.5 text-[#e8002d] flex-shrink-0" />
                    }
      ...
      <div className="mt-6 flex items-center justify-end gap-3 bg-[#0d1220] border border-[#1e2d42] rounded-lg px-5 py-3">
        <button
          onClick={handleReset}
          className="flex items-center gap-2 px-4 py-2 rounded text-sm text-[#7d92b0] border border-[#1e2d42]
                     hover:bg-[#1e2d42] transition-colors"
        >
