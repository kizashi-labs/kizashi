      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg shadow-2xl">
        ...
        <div className="px-6 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
          <div>
            ...
            <input
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/60"
              value={form.name}
          ...
          <div>
            ...
            <textarea
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/60 resize-none"
              rows={2}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {ALL_MODULES.map(m => (
                ...
                >
                  {form.content_modules.includes(m) && <CheckCircle2 className="w-3.5 h-3.5 text-[#e8002d] shrink-0" />}
              ...
              {detail.module_completions.map(mc => (
                <div key={mc.module} className="bg-[#070d19] border border-[#1e2d42] rounded-lg p-3">
                  ...
                  <div className="h-1.5 bg-[#1e2d42] rounded-full overflow-hidden">
                    <div
                      className="h-full bg-linear-to-r from-[#e8002d] to-[#ff4d6d] rounded-full"
            ...
            <div className="bg-[#070d19] border border-[#1e2d42] rounded-lg p-4">
              <div className="flex items-end gap-4">
                <div className="flex-1">
                  ...
                  <div className="h-16 bg-[#1e2d42] rounded-sm relative overflow-hidden">
                    <div
                      className="absolute bottom-0 left-0 right-0 bg-[#7d92b0]/40 rounded-sm"
                ...
                <div className="flex-1">
                  ...
                  <div className="h-16 bg-[#1e2d42] rounded-sm relative overflow-hidden">
                    <div
                      className="absolute bottom-0 left-0 right-0 bg-[#e8002d]/40 rounded-sm"
...
export default function AwarenessCampaignsPage() {
  ...
  const { data = [], isError } = useQuery<Campaign[]>({
    ...
    queryFn: () => apiFetchList<Campaign>('/api/v1/admin/awareness-campaigns'),
    staleTime: 60_000,
  })
