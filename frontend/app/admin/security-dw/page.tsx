      ...
      <div className="flex gap-4 mb-6">
        ...
        <div className="w-[60%] bg-[#0d1220] border border-[#1e2d42] rounded-lg p-4 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            {selectedDataset && (
              <span className="text-xs text-[#7d92b0] bg-[#1e2d42] px-2 py-1 rounded">
          ...
          <textarea
            ...
            className="w-full h-36 bg-[#070d19] border border-[#1e2d42] rounded-lg p-3 text-white font-mono text-sm resize-none focus:outline-none focus:border-[#e8002d]/50"
            spellCheck={false}
          />
          <button
          ...
          {queryResult && (
            <div className="border border-[#1e2d42] rounded-lg p-3">
              <div className="flex items-center justify-between mb-3">
                ...
                <button onClick={downloadCSV} className="flex items-center gap-1.5 text-xs bg-[#1e2d42] hover:bg-[#2e4060] px-3 py-1.5 rounded text-[#7d92b0] hover:text-white transition-colors">
