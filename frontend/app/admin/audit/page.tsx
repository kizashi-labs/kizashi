    ...
    <div className="bg-[#111827] border border-[#1e2d42] rounded-xl p-5 space-y-5">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-1.5 text-xs border border-[#1e2d42] rounded-lg bg-[#080c14] text-white focus:outline-hidden focus:border-cyan-500 transition-colors [color-scheme:dark]"
          />
        </div>
      ...
      <div className="flex justify-end pt-1">
        <button
          ...
          className="flex items-center gap-2 px-5 py-2 bg-cyan-700 hover:bg-cyan-600 border border-cyan-500 text-white text-sm font-medium rounded-lg transition-colors"
        >
...
export default function AdminAuditPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#161f33] border border-[#1e2d42] text-[#8899aa] hover:text-white hover:bg-[#1d2f4a] text-sm rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
            <Download className="w-4 h-4" />
            CSVエクスポート
          </button>
      ...
      {/* ─── フィルターバー ──────────────────────────────────────────── */}
      <div className="flex flex-wrap items-center gap-3 bg-[#111827] border border-[#1e2d42] rounded-xl px-4 py-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="メールで検索..."
            className="pl-8 pr-3 py-1.5 text-xs border border-[#1e2d42] rounded-lg bg-[#080c14] text-white placeholder-[#5a6a7a] w-52 focus:outline-hidden focus:border-purple-500 transition-colors"
          />
        </div>
        ...
        {hasFilters && (
          <button
            ...
            className="flex items-center gap-1 text-xs text-[#8899aa] hover:text-white px-2 py-1 rounded-lg hover:bg-[#161f33] transition-colors ml-auto"
          >
