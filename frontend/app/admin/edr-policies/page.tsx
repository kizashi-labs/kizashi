            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded text-white text-sm placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded text-white text-sm placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50 resize-none"
                />
              </div>
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded text-white text-sm focus:outline-none focus:border-[#e8002d]/50"
                >
              ...
              {form.rules_config.process_monitoring.enabled && (
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 bg-[#0d1220] border border-[#1e2d42] rounded text-white text-xs font-mono placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50 resize-none"
                  />
                </div>
              )}
            </div>
              ...
              {form.rules_config.file_monitoring.enabled && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-[#0d1220] border border-[#1e2d42] rounded text-white text-sm font-mono placeholder-[#3d5068] focus:outline-none focus:border-[#e8002d]/50"
                  />
                </div>
              )}
            </div>
                          ...
                          <div className="space-y-1">
                            {assignments.filter(a => a.policy_id === policy.id).map(a => (
                              <div key={a.id} className="flex items-center gap-2 text-xs">
                                <span className={`px-1.5 py-0.5 rounded text-[10px] ${a.target_type === 'group' ? 'bg-blue-500/20 text-blue-400' : 'bg-green-500/20 text-green-400'}`}>
            ...
            <div className="flex flex-wrap items-center gap-3 px-5 py-4 border-b border-[#1e2d42]">
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded text-white text-sm focus:outline-none"
                >
                ...
                <select
                  ...
                  className="px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded text-white text-sm focus:outline-none min-w-[200px]"
                >
                    ...
                    filteredAssignments.map(asgn => {
                      ...
                      return (
                        <tr key={asgn.id} className="hover:bg-[#0a1128] transition-colors">
                          ...
                          <td className="px-4 py-3">
                            <span className={`text-xs px-2 py-0.5 rounded ${asgn.target_type === 'group' ? 'bg-blue-500/20 text-blue-400' : 'bg-green-500/20 text-green-400'}`}>
                          ...
                          <td className="px-4 py-3">
                            <button
                              ...
                              className="text-xs px-3 py-1 text-[#e8002d] border border-[#e8002d]/30 hover:bg-[#e8002d]/10 rounded transition-colors"
                            >
                              割り当て解除
                            </button>
                          </td>
