              ...
              <div className="space-y-2">
                ...
                {mappings.map((m, i) => (
                  <div key={i} className="grid grid-cols-[1fr_auto_1fr_auto] gap-2 items-center">
                    <input
                      className="bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#e8002d]/60 font-mono"
          ...
          {platforms.map(p => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className={`w-5 h-5 rounded-full border-2 shrink-0 ${p.enabled ? 'bg-[#e8002d] border-[#e8002d]' : 'bg-transparent border-[#3d5068]'}`} />
              </div>
