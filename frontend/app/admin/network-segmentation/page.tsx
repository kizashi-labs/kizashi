    ...
    <div className="min-h-screen bg-[#070d19] p-6 space-y-6">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-sm border ${seg.status === 'active' ? 'text-[#00c853] border-[#00c853]/30 bg-[#00c853]/10' : 'text-[#7d92b0] border-[#1e2d42] bg-[#1e2d42]/30'}`}>
        ...
        <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-4 border-b border-[#1e2d42]">
            ...
            <button
              ...
              className="ml-auto p-1.5 rounded-sm hover:bg-[#1e2d42] text-[#7d92b0] hover:text-[#e2e8f4] transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          <div className="p-5 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-sm text-sm font-medium bg-[#e8002d]/10 border border-[#e8002d]/30 text-[#e8002d] hover:bg-[#e8002d]/20 transition-colors mt-2"
              >
            ...
            <div>
              ...
              <div className="space-y-2">
                {selected.devices.map(d => (
                  <div key={d.ip} className="flex items-center gap-3 px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded-sm">
            ...
            <div>
              ...
              <div className="space-y-2">
                {segData.policies
                  ...
                  .map(p => (
                    <div key={p.id} className="px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded-sm space-y-1">
                      <div className="flex items-center gap-2">
        ...
        <div className="p-6">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {segData.policies.map(p => {
              ...
              return (
                <div key={p.id} className="flex items-center gap-2 px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded-sm text-xs font-mono">
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg overflow-hidden">
        <div className="flex items-center gap-3 px-5 py-4 border-b border-[#1e2d42]">
          ...
          <span className="ml-auto text-xs text-[#7d92b0] bg-[#1e2d42] px-2 py-0.5 rounded-sm">{segData.policies.length}件</span>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg shadow-2xl">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 border-t border-[#1e2d42]">
              <button onClick={() => setShowAddSegment(false)} className="px-4 py-2 rounded-sm text-sm text-[#7d92b0] hover:text-[#e2e8f4] transition-colors">キャンセル</button>
              <button
                onClick={() => addSegmentMutation.mutate(segmentForm)}
                disabled={addSegmentMutation.isPending || !segmentForm.name}
                className="flex items-center gap-2 px-5 py-2 rounded-sm bg-[#e8002d] hover:bg-[#c0001f] text-white text-sm font-medium disabled:opacity-50 transition-colors"
              >
      ...
      {showAddPolicy && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl w-full max-w-lg shadow-2xl">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 border-t border-[#1e2d42]">
              <button onClick={() => setShowAddPolicy(false)} className="px-4 py-2 rounded-sm text-sm text-[#7d92b0] hover:text-[#e2e8f4] transition-colors">キャンセル</button>
              <button
