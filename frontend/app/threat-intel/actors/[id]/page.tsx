            ...
            <div className="space-y-1 pt-1">
              {(byTactic[tactic] || []).map(t => (
                <div
                  ...
                  className="bg-[#e8002d]/20 border border-[#e8002d]/30 text-[#f87171] text-[10px] px-2 py-1 rounded cursor-default hover:bg-[#e8002d]/30 transition-colors"
                >
    ...
    <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg overflow-hidden">
      ...
      >
        <div className="flex items-start gap-3 flex-1 min-w-0">
          <div className={`mt-0.5 w-2 h-2 rounded-full flex-shrink-0 ${campaign.status === 'active' ? 'bg-green-400 animate-pulse' : 'bg-[#3d5068]'}`} />
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {campaign.targeted_sectors.map(s => (
                <span key={s} className="px-2 py-0.5 rounded text-[11px] bg-blue-500/15 text-blue-400 border border-blue-500/30">
                  {s}
                </span>
              ))}
            </div>
...
const iocTypeBadge = (type: string) => {
  ...
  return (
    <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-semibold border uppercase ${cfgs[type] ?? 'bg-[#1e2d42] text-[#7d92b0] border-[#1e2d42]'}`}>
      {type}
    </span>
  )
}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5 mt-3">
              {actor.aliases.map(alias => (
                <span key={alias} className="px-2 py-0.5 rounded text-[11px] bg-[#1e2d42] text-[#7d92b0] border border-[#1e2d42]">
                  {alias}
                </span>
              ))}
            </div>
      ...
      {activeTab === '概要' && (
        <div className="space-y-6">
            ...
            <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {actor.target_industries.map(ind => (
                  <span key={ind} className="px-2.5 py-1 rounded text-sm bg-[#1e2d42] text-[#e2e8f4] border border-[#1e2d42]">
                    {ind}
                  </span>
                ))}
              </div>
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
              {actor.target_regions.map(r => (
                <div key={r.country} className="flex items-center gap-2 px-3 py-2 rounded bg-[#070d19] border border-[#1e2d42]">
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5">
            ...
            <div className="flex flex-wrap gap-2">
              {actor.aliases.map(alias => (
                <span key={alias} className="px-3 py-1.5 rounded text-sm bg-[#1e2d42] text-[#e2e8f4] border border-[#1e2d42] font-mono">
                  {alias}
                </span>
              ))}
            </div>
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5">
            ...
            <div className="mb-4">
              <div className="h-1.5 bg-[#1e2d42] rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#e8002d] to-[#ff6b6b] rounded-full transition-all"
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#0d1220] border border-[#1e2d42] text-[#7d92b0] hover:text-[#e2e8f4] hover:border-[#7d92b0]/40 text-xs transition-colors"
            >
                    ...
                    <tr key={ioc.id} className={`border-b border-[#1e2d42] hover:bg-[#111827] transition-colors ${i % 2 === 0 ? '' : 'bg-[#070d19]/30'}`}>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          ...
                          <Link href="/ioc" className="p-1.5 rounded hover:bg-[#1e2d42] text-[#7d92b0] hover:text-[#e2e8f4] transition-colors" title="IOC管理で表示">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  disabled={iocPage === 1}
                  className="px-3 py-1.5 rounded bg-[#0d1220] border border-[#1e2d42] text-[#7d92b0] disabled:opacity-40 hover:border-[#7d92b0]/40 transition-colors"
                >
                  前へ
                </button>
          ...
          {actor.reports.map(report => (
            <div key={report.id} className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-5 hover:border-[#7d92b0]/30 transition-colors">
              <div className="flex items-start justify-between gap-4">
                ...
                <a
                  href={report.pdf_url}
                  className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#e8002d]/15 border border-[#e8002d]/30 text-[#f87171] hover:bg-[#e8002d]/25 transition-colors text-sm font-medium"
                >
