  ...
  return (
    <div>
      <div className="flex flex-wrap gap-1.5 mb-2">
        {values.map(v => (
          <span key={v} className="flex items-center gap-1 text-xs px-2 py-0.5 rounded bg-[#1e2d42] text-[#8899aa]">
            {v}
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 text-xs bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-1.5
                     text-[#e2e8f4] placeholder-[#3d5068] focus:outline-none focus:border-blue-500"
        />
        <button
          onClick={add}
          className="flex items-center gap-1 px-2.5 py-1.5 text-xs bg-[#1e2d42] hover:bg-[#253649]
        ...
        <div className="mb-6 p-4 bg-[#111827] rounded-xl border border-[#1e2d42]">
          ...
          <div className="flex gap-2">
            <select
              ...
              defaultValue=""
              className="flex-1 bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm
          ...
          <SectionCard title="基本設定" icon={FileText} iconColor="text-blue-400">
            <FieldRow label="ポリシー名" hint="新規作成時に使用されます">
              <input
                ...
                className="w-full bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm
                           text-[#e2e8f4] placeholder-[#3d5068] focus:outline-none focus:border-blue-500"
              />
            </FieldRow>
            ...
            <FieldRow label="スキャン間隔" hint="5〜1440分">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-24 bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm
                             text-[#e2e8f4] focus:outline-none focus:border-blue-500"
                />
            ...
            <FieldRow label="メモリ上限" hint="64MB以上">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-28 bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm
                             text-[#e2e8f4] focus:outline-none focus:border-blue-500"
                />
          ...
          <SectionCard title="監視オプション" icon={Network} iconColor="text-cyan-400">
            ...
            <FieldRow label="ログレベル">
              <select
                ...
                className="bg-[#0d1220] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm
                           text-[#e2e8f4] focus:outline-none focus:border-blue-500"
              >
