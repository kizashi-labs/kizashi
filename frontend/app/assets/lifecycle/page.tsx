                ...
                {filteredAssets.map(asset => {
                  ...
                  return (
                    <tr key={asset.id} className="hover:bg-[#0a1628] transition-colors">
                      ...
                      <td className="px-3 py-2.5">
                        <span className={`flex items-center gap-1 px-2 py-0.5 rounded-sm border w-fit text-[10px] font-medium ${TYPE_COLORS[asset.type]}`}>
                      ...
                      <td className="px-3 py-2.5">
                        <span className={`px-2 py-0.5 rounded-sm border text-[10px] font-medium ${STAGE_COLORS[asset.lifecycle_stage]}`}>
                  ...
                  {warrantyAlerts.map(asset => {
                    ...
                    return (
                      <tr key={asset.id} className="hover:bg-orange-500/5 transition-colors">
                        ...
                        <td className="px-3 py-2.5">
                          <button className="text-xs text-blue-400 hover:text-blue-300 border border-blue-400/30 px-2 py-1 rounded-sm transition-colors">
                            更新手続き
                          </button>
                        </td>
                      </tr>
              ...
              {tcoByType.map(([type, stats]) => {
                ...
                return (
                  <div key={type} className="flex items-center gap-3">
                    <div className={`flex items-center gap-1 px-2 py-0.5 rounded-sm border text-[10px] w-28 ${TYPE_COLORS[type]}`}>
                      <TypeIcon type={type} />
              ...
              <div className="flex gap-3 pt-2 border-t border-falcon-border">
                {nextStage(selectedAsset.lifecycle_stage) && (
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-sm bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-sm hover:bg-cyan-500/20 transition-colors"
                  >
          ...
          <div className="bg-falcon-surface border border-falcon-border rounded-xl p-6 w-96 shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-sm bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-sm hover:bg-cyan-500/20 transition-colors disabled:opacity-50"
              >
