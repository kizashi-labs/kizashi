  ...
  return (
    <div className="border-b border-[#1e2d42] last:border-0">
      ...
      >
        ...
        {open
          ? <ChevronUp className="w-4 h-4 text-[#e8002d] shrink-0" />
          : <ChevronDown className="w-4 h-4 text-[#3d5068] shrink-0" />
        }
      </button>
      {open && (
    ...
    <div className="min-h-screen bg-[#070d19] p-6 max-w-3xl mx-auto">
      ...
      {plan === 'free' && (
        <div className="mb-6 bg-[#0d1220] border border-[#1e2d42] rounded-xl p-4 flex items-center gap-4">
          <Shield className="w-5 h-5 text-[#e8002d] shrink-0" />
          ...
          <Link
            href="/admin/license"
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#e8002d]/10 border border-[#e8002d]/30 text-[#e8002d] text-xs font-medium rounded-lg hover:bg-[#e8002d]/20 transition-colors shrink-0"
          >
            プランを確認
            <ArrowRight className="w-3 h-3" />
          </Link>
      ...
      <div className="mt-8 bg-[#0d1220] border border-[#1e2d42] rounded-xl p-5 text-center">
        ...
        <Link
          href="/admin/guide"
          className="inline-flex items-center gap-2 px-4 py-2 bg-[#1d2f4a] hover:bg-[#253d5e] border border-[#2a3f60] text-sm text-white rounded-lg transition-colors"
        >
          管理者向け詳細ガイドを開く
