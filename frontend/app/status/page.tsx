...
function UptimeBar({ pct }: { pct: number }) {
  return (
    <div className="flex-1 h-8 rounded-sm bg-[#1e2d42] overflow-hidden">
      <div
        ...
        <section>
          ...
          <div className="bg-[#0d1220] rounded-xl border border-[#1e2d42] p-6 space-y-6">
            ...
            <div>
              ...
              <div className="flex justify-between mt-1 text-xs text-[#7d92b0]/60">
            ...
            <div className="flex items-center gap-5 text-xs text-[#7d92b0]">
              <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-sm bg-emerald-500 inline-block" />正常</span>
              <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-sm bg-yellow-400 inline-block" />一部障害</span>
              <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-sm bg-[#e8002d] inline-block" />障害</span>
            </div>
          </div>
        </section>
                ...
                {endpoints.map((ep, i) => (
                  <tr key={i} className="hover:bg-[#1e2d42]/30 transition-colors">
                    ...
                    <td className="px-5 py-3 hidden sm:table-cell">
                      <span className="px-2 py-0.5 rounded text-xs font-mono font-semibold bg-[#1e2d42] text-blue-300">
                        {ep.method}
                      </span>
                    </td>
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 bg-[#070d19] border border-[#1e2d42] rounded-lg px-4 py-2.5 text-sm text-gray-200 placeholder-[#7d92b0]/50 focus:outline-none focus:border-[#e8002d]/60 transition-colors"
                />
                <button
                  type="submit"
