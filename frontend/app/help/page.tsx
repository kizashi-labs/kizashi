...
function KbdKey({ children }: { children: string }) {
  return (
    <kbd
      className="inline-flex items-center px-2 py-0.5 rounded border border-[#1e2d42]
                 bg-[#070d19] text-[#e2e8f4] text-[11px] font-mono font-semibold
    ...
    <div className="border border-[#1e2d42] rounded-lg overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between gap-4 px-5 py-4
                   bg-[#0d1220] hover:bg-[#111827] transition-colors text-left"
      >
        <span className="text-sm font-medium text-[#e2e8f4]">{question}</span>
        {open ? (
          <ChevronDown className="w-4 h-4 text-[#7d92b0] flex-shrink-0" />
        ) : (
          <ChevronRight className="w-4 h-4 text-[#7d92b0] flex-shrink-0" />
        )}
      </button>
      {open && (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm bg-[#0d1220] border border-[#1e2d42] rounded-lg
              ...
              return (
                <Link
                  ...
                  className={`flex items-start gap-3 p-4 rounded-xl border cursor-pointer
                              ...
                              ${cat.bg} ${cat.border}`}
                >
                  <div className={`mt-0.5 flex-shrink-0 ${cat.color}`}>
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm
                           ...
                           hover:border-[#e8002d]/40 hover:text-[#e2e8f4] transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm
                           bg-[#070d19] border border-[#1e2d42] text-[#7d92b0]
                           hover:border-[#7d92b0]/40 hover:text-[#e2e8f4] transition-colors"
              >
