                  ...
                  {[...analysts].sort((a, b) => b.alerts_handled - a.alerts_handled).map(a => (
                    <tr key={a.id} className="hover:bg-[#0a1020] transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-full bg-linear-to-br from-[#1a6bff] to-[#0044cc] flex items-center justify-center text-white text-xs font-bold">
                            {a.name[0]}
                          </div>
                  ...
                  <div className="space-y-1.5">
                    {categories.map(cat => (
                      <div key={cat} className="flex items-center gap-2">
                        <ChevronRight className="w-3 h-3 text-[#3d5068] shrink-0" />
              ...
              {[
                ...
                return (
                  <div key={label} className="flex items-center gap-4">
                    <span className="text-[#7d92b0] text-sm w-48 shrink-0">{label}</span>
              ...
              {[...efficiency.tools].sort((a, b) => b.usage_count - a.usage_count).map(t => {
                ...
                return (
                  <div key={t.name} className="flex items-center gap-4">
                    <span className="text-[#7d92b0] text-sm w-32 shrink-0">{t.name}</span>
