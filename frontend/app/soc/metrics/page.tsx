    ...
    <div className="space-y-1.5">
      {steps.map((step, i) => (
        <div key={step.label} className="flex items-center gap-3">
          <div className="w-28 text-right text-xs text-[#7d92b0] flex-shrink-0">{step.label}</div>
          <div
          ...
          <span className="text-[#7d92b0] text-xs flex-shrink-0">{step.pct}%</span>
          {i > 0 && (
                ...
                <tbody className="divide-y divide-[#1e2d42]">
                  {analysts.map((analyst, idx) => (
                    <tr key={analyst.id} className="hover:bg-[#1e2d42]/30 transition-colors">
                      ...
                      <td className="px-4 py-2.5">
                        <span className={`px-2 py-0.5 rounded text-xs font-bold ${tierBadge(analyst.tier)}`}>
                          {analyst.tier}
                        </span>
                      </td>
            ...
            <div className="space-y-3">
              {analysts.map(analyst => (
                <div key={analyst.id} className="flex items-center gap-3">
                  <div className="w-24 text-sm text-[#7d92b0] truncate flex-shrink-0">{analyst.name.split(' ')[0]}</div>
                  ...
                  <span className={`text-xs font-medium w-14 text-right flex-shrink-0 ${analyst.current_workload >= 20 ? 'text-red-400' : analyst.current_workload >= 12 ? 'text-yellow-400' : 'text-green-400'}`}>
            ...
            <div className="space-y-3">
              {ageBuckets.map(bucket => (
                <div key={bucket.label} className="flex items-center gap-3">
                  <div className="w-24 text-sm text-[#7d92b0] flex-shrink-0">{bucket.label}</div>
                  <div className="flex-1 h-7 bg-[#1e2d42] rounded overflow-hidden">
                    <div
                  ...
                  <span className="text-[#7d92b0] text-xs w-16 text-right flex-shrink-0">
                  ...
                  {categories.map(cat => {
                    ...
                    return (
                      <tr key={cat.name} className="hover:bg-[#1e2d42]/30 transition-colors">
                        ...
                        <td className="px-4 py-2.5">
                          <div className="w-32 h-3 bg-[#1e2d42] rounded overflow-hidden">
                            <div
                              className="h-full rounded bg-[#3b82f6]/60"
              ...
              <div className="space-y-3">
                {resolutionMethods.map(method => (
                  <div key={method.label}>
                    ...
                    <div className="h-4 bg-[#1e2d42] rounded overflow-hidden">
                      <div
