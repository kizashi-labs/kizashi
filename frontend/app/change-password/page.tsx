    ...
    <div className="min-h-screen flex items-center justify-center bg-[#080c14] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#e8002d] to-[#a80020]
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                autoComplete="new-password"
                className={`w-full bg-[#0d1220] border text-[#e2e8f4] rounded
                           pl-9 pr-10 py-2.5 text-sm
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5
                       bg-[#1a6bff] hover:bg-[#1557cc] text-white text-sm font-semibold
