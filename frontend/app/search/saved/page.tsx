        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-2 text-sm text-[#e2e8f4] focus:outline-hidden focus:border-[#3d5068] placeholder-[#3d5068]"
              placeholder="検索名を入力"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-2 text-sm text-[#e2e8f4] focus:outline-hidden focus:border-[#3d5068]"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-2 text-sm text-[#e2e8f4] font-mono focus:outline-hidden focus:border-[#3d5068] placeholder-[#3d5068] resize-none"
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2 rounded-sm border border-[#1e2d42] text-[#7d92b0] hover:text-white hover:border-[#3d5068] text-sm transition-colors"
            >
              キャンセル
            </button>
            <button
              type="submit"
              className="flex-1 px-4 py-2 rounded-sm bg-[#e8002d] hover:bg-[#c0001f] text-white text-sm font-medium transition-colors"
            >
              {initial ? '更新' : '保存'}
            </button>
          </div>
    ...
    <div className="min-h-screen bg-[#070d19] p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-1">
          <div className="w-8 h-8 rounded-sm bg-[#e8002d]/20 flex items-center justify-center">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {[
          ...
          <div key={label} className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-4 flex items-center gap-3">
            <div className={`w-9 h-9 rounded-sm bg-[#1e2d42] flex items-center justify-center shrink-0`}>
          ...
          {systemFilters.map(f => {
            ...
            return (
              <div key={f.id} className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-4 flex flex-col gap-2 hover:border-[#3d5068] transition-colors group">
                ...
                <code className="text-[#7d92b0] text-[10px] font-mono bg-[#070d19] px-2 py-1 rounded-sm border border-[#1e2d42] truncate block">
                  {f.query}
                </code>
                <button
                  onClick={() => handleRunSystem(f)}
                  className="mt-auto w-full py-1.5 rounded-sm bg-[#1e2d42] hover:bg-[#e8002d] text-[#7d92b0] hover:text-white text-xs font-medium transition-colors flex items-center justify-center gap-1.5"
                >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-[#070d19] border border-[#1e2d42] rounded-sm px-3 py-1.5 text-xs text-[#7d92b0] focus:outline-hidden focus:border-[#3d5068] pr-7"
              >
            ...
            return (
              <div key={s.id} className="p-4 flex items-center gap-4 hover:bg-[#0a1525] transition-colors group">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <code className="text-[#7d92b0] text-[11px] font-mono bg-[#070d19] px-2 py-0.5 rounded-sm border border-[#1e2d42] truncate inline-block max-w-lg">
                    {s.query}
                  </code>
                  <div className="flex items-center gap-3 mt-1.5">
                    ...
                    {s.tags.map(t => (
                      <span key={t} className="text-[#3d5068] text-[10px] px-1.5 py-0.5 rounded-sm bg-[#1e2d42]">{t}</span>
                    ))}
                  </div>
                </div>
                {/* Actions */}
                <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    onClick={() => handleRun(s)}
                    title="実行"
                    className="flex items-center gap-1 px-2.5 py-1.5 rounded-sm bg-[#e8002d]/20 hover:bg-[#e8002d] text-[#e8002d] hover:text-white text-xs font-medium transition-colors"
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-sm transition-colors ${s.shared ? 'bg-emerald-500/20 text-emerald-400 hover:bg-emerald-500/40' : 'bg-[#1e2d42] text-[#7d92b0] hover:text-white'}`}
                  >
                  ...
                  <button
                    ...
                    title="編集"
                    className="p-1.5 rounded-sm bg-[#1e2d42] text-[#7d92b0] hover:text-white transition-colors"
                  >
                  ...
                  <button
                    ...
                    title="削除"
                    className="p-1.5 rounded-sm bg-[#1e2d42] text-[#7d92b0] hover:text-red-400 transition-colors"
                  >
