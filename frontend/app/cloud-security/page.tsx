            ...
            <div className="space-y-2">
              {finding.remediation_steps.map((step, i) => (
                <div key={i} className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#e8002d]/20 border border-[#e8002d]/40 flex items-center justify-center text-[11px] font-bold text-[#e8002d]">
                    {i + 1}
                  </span>
      ...
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-[#1e2d42] flex items-center gap-3 flex-wrap">
          ...
          <select value={severityFilter} onChange={e => setSeverityFilter(e.target.value as Severity | 'all')}
            className="bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-1.5 text-xs text-white focus:outline-none focus:border-[#e8002d]/60">
