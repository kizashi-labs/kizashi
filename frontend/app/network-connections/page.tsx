      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => refetch()}
            disabled={isFetching}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#111827] border border-[#1e2d42]
                       hover:bg-[#19253d] text-white text-sm rounded-lg transition-colors disabled:opacity-50"
          >
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-xs">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-[#111827] border border-[#1e2d42] rounded-lg
                       text-white text-sm placeholder-[#5a6a7a] focus:outline-none focus:border-[#1a6bff]"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-2 bg-[#111827] border border-[#1e2d42] rounded-lg text-sm text-white
                     focus:outline-none focus:border-[#1a6bff] min-w-[160px]"
        >
        ...
        <select
          ...
          className="px-3 py-2 bg-[#111827] border border-[#1e2d42] rounded-lg text-sm text-white
                     focus:outline-none focus:border-[#1a6bff] min-w-[150px]"
        >
        ...
        <div className="flex items-center justify-between text-sm text-[#8899aa]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page === 1}
              className="px-3 py-1.5 bg-[#111827] border border-[#1e2d42] rounded-lg
                         hover:bg-[#19253d] disabled:opacity-40 transition-colors"
            >
              前へ
            </button>
