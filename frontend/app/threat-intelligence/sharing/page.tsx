...
function TLPBadge({ level }: { level: string }) {
  ...
  return (
    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-sm border whitespace-nowrap ${cfg[level] ?? 'bg-[#1e2d42] text-[#7d92b0]'}`}>
      TLP:{level}
    </span>
  )
}
...
function FormatBadge({ fmt }: { fmt: string }) {
  ...
  return (
    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-sm uppercase ${colors[fmt] ?? 'bg-[#1e2d42] text-[#7d92b0]'}`}>
      {fmt}
    </span>
  )
}
                  ...
                  <tr key={g.id} className="border-b border-[#1e2d42] last:border-0 hover:bg-[#19253d] transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="text-xs px-3 py-1 rounded-sm bg-[#1e2d42] text-[#7d92b0] hover:text-white transition-colors flex items-center gap-1"
                      >
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-6 w-[480px] space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#1a6bff]"
                  value={newGroup.name}
              ...
              <div>
                ...
                <textarea
                  className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#1a6bff] resize-none"
                  rows={2}
            ...
            <tbody>
              {partners.map(p => (
                <tr key={p.id} className="border-b border-[#1e2d42] last:border-0 hover:bg-[#19253d] transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span className="text-xs bg-[#1e2d42] text-[#7d92b0] px-2 py-0.5 rounded-sm uppercase">{p.auth_type}</span>
                  </td>
            ...
            <div className="space-y-3">
              ...
              {newPartner.auth_type === 'basic' && (
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#1a6bff]" value={newPartner.username} onChange={e => setNewPartner(p => ({ ...p, username: e.target.value }))} />
                  </div>
                  <div>
                    <label className="text-xs text-[#7d92b0] block mb-1">パスワード</label>
                    <input type="password" className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#1a6bff]" value={newPartner.password} onChange={e => setNewPartner(p => ({ ...p, password: e.target.value }))} />
                  </div>
                </div>
              )}
              {newPartner.auth_type === 'token' && (
                <div>
                  ...
                  <input type="password" className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#1a6bff]" value={newPartner.token} onChange={e => setNewPartner(p => ({ ...p, token: e.target.value }))} />
                </div>
              )}
            </div>
            <div className="flex gap-3 pt-2">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#1a6bff]" value={dateRange.from} onChange={e => setDateRange(p => ({ ...p, from: e.target.value }))} />
              </div>
              <div>
                <label className="text-xs text-[#7d92b0] block mb-1">終了日</label>
                <input type="date" className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-white text-sm focus:outline-hidden focus:border-[#1a6bff]" value={dateRange.to} onChange={e => setDateRange(p => ({ ...p, to: e.target.value }))} />
              </div>
            </div>
            ...
            <tbody>
              {m(MOCK_IMPORTS).map(im => (
                <tr key={im.id} className="border-b border-[#1e2d42] last:border-0 hover:bg-[#19253d] transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span className="text-xs bg-[#1e2d42] text-[#7d92b0] px-2 py-0.5 rounded-sm">{im.format}</span>
                  </td>
  ...
  return (
    <div className="min-h-screen bg-[#070d19] text-[#7d92b0]">
      ...
      <div className="border-b border-[#1e2d42] bg-[#0d1220] px-6 py-4">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-linear-to-br from-[#1a6bff] to-[#0044cc] flex items-center justify-center">
