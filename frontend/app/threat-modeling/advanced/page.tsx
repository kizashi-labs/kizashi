                            ...
                            <div key={threat.id} className="px-4 py-3">
                              <div className="flex items-start justify-between gap-3">
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                  ...
                                  <button onClick={() => setEditingThreat(threat)} className="p-1 rounded-sm hover:bg-[#1e2d42] text-[#7d92b0] transition-colors"><Edit3 className="w-3.5 h-3.5" /></button>
                                </div>
                              </div>
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-2xl w-full max-w-lg shadow-2xl">
            ...
            <div className="px-6 py-5 space-y-4">
              <div>
                ...
                <textarea defaultValue={editingThreat.description} rows={3} className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden focus:border-[#7d92b0]/50 resize-none" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs text-[#7d92b0] mb-1.5">可能性 (1-5)</label>
                  <input type="number" min={1} max={5} defaultValue={editingThreat.likelihood} className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden" />
                </div>
                <div>
                  <label className="block text-xs text-[#7d92b0] mb-1.5">影響 (1-5)</label>
                  <input type="number" min={1} max={5} defaultValue={editingThreat.impact} className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden" />
                </div>
              </div>
              <div>
                <label className="block text-xs text-[#7d92b0] mb-1.5">緩和策</label>
                <textarea defaultValue={editingThreat.mitigations} rows={2} className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden resize-none" />
              </div>
              <div>
                <label className="block text-xs text-[#7d92b0] mb-1.5">ステータス</label>
                <select defaultValue={editingThreat.status} className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden">
        ...
        {currentStage === 1 && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea defaultValue={pasta.objectives} rows={6} className="w-full px-4 py-3 rounded-xl bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden focus:border-[#7d92b0]/50 resize-none" />
            </div>
          </div>
        )}
        {currentStage === 2 && (
            ...
            <div className="space-y-2">
              {pasta.scope_components.map((comp, i) => (
                <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-[#0d1220] border border-[#1e2d42]">
                  ...
                  <button className="p-1 rounded-sm hover:bg-[#1e2d42] text-[#7d92b0] transition-colors"><Trash2 className="w-3.5 h-3.5" /></button>
                </div>
              ))}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-xs text-[#e8002d] bg-[#e8002d]/10 px-2 py-0.5 rounded-sm border border-[#e8002d]/30">HTTPS</div>
                    <div className="h-px w-12 bg-[#e8002d]/50" />
                  </div>
                </div>
                <div className="text-center">
...
export default function AdvancedThreatModelingPage() {
  ...
  const { data: model } = useQuery<ThreatModel>({
    ...
    // 以前はここが placeholderData: MOCK_MODEL で、作成者「田中太郎」の
    // 脅威モデルが取得の成否にかかわらず必ず描かれていました。
    ...(USE_MOCK ? { placeholderData: MOCK_MODEL } : {}),
    retry: 0,
  })
  ...
  const activeModel: ThreatModel = { ...EMPTY_MODEL, ...(model ?? mockOr(MOCK_MODEL, EMPTY_MODEL)) }
          ...
          <div className="flex items-center gap-6 flex-wrap">
            <div>
              ...
              <input
                ...
                className="px-3 py-1.5 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden focus:border-[#7d92b0]/50 w-80"
              />
            </div>
            <div>
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-2xl w-full max-w-md shadow-2xl">
            ...
            <div className="px-6 py-5 space-y-4">
              <div>
                ...
                <input value={modelName} onChange={e => setModelName(e.target.value)} className="w-full px-3 py-2 rounded-lg bg-[#070d19] border border-[#1e2d42] text-white text-sm focus:outline-hidden" />
              </div>
