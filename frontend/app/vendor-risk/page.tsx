        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="ml-auto flex items-center gap-2 px-4 py-2 bg-[#e8002d] hover:bg-[#c0001f] text-white text-sm font-medium rounded-sm transition-colors"
            >
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-6 w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={newVendor.name} onChange={e => setNewVendor(p => ({ ...p, name: e.target.value }))}
                  ...
                  className="w-full px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded-sm text-sm text-white placeholder-[#3d5068] focus:outline-hidden focus:border-[#7d92b0]/50" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea value={newVendor.notes} onChange={e => setNewVendor(p => ({ ...p, notes: e.target.value }))}
                  ...
                  className="w-full px-3 py-2 bg-[#070d19] border border-[#1e2d42] rounded-sm text-sm text-white placeholder-[#3d5068] focus:outline-hidden focus:border-[#7d92b0]/50 resize-none" />
              </div>
            </div>
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-[#e8002d] hover:bg-[#c0001f] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-sm text-sm font-medium transition-colors"
              >
                追加
              </button>
            </div>
          ...
          <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-6 w-full max-w-lg shadow-2xl max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button onClick={submitAssessment}
                className="flex-1 px-4 py-2 bg-[#e8002d] hover:bg-[#c0001f] text-white rounded-sm text-sm font-medium transition-colors">
                評価を保存
              </button>
            </div>
          </div>
