      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className={`mt-0.5 inline-block px-1.5 py-0.5 rounded text-[10px] font-medium ${statusColor}`}>
              {statusLabel}
            </span>
          </div>
        </div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full text-sm bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2
                         text-[#c9d6e8] focus:outline-none focus:border-blue-500"
            >
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            {lateralMovementCount > 0 && (
              <span className="ml-auto px-1.5 py-0.5 rounded bg-red-900/40 text-red-300 text-[10px] font-semibold border border-red-700/50">
                {lateralMovementCount}
              </span>
            )}
          </label>
          ...
          talkers.map(({ id, count, node }) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs font-mono text-[#7d92b0] flex-shrink-0">{count} 接続</span>
              </button>
            )
          })
        )}
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={isFetching}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#0d1220] border border-[#1e2d42]
                       hover:bg-[#111827] text-white text-sm rounded-lg transition-colors disabled:opacity-50"
          >
