...
function SeverityBadge({ severity }: { severity: number }) {
  return (
    <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide ${SEVERITY_COLORS[severity] ?? 'bg-slate-700 text-slate-300'}`}>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-6 w-full max-w-md shadow-xl">
        ...
        <textarea
          className="w-full bg-[#070d19] border border-[#1e2d42] rounded text-[#e2e8f4] text-sm p-3 resize-none focus:outline-none focus:border-[#e8002d]/50 h-28"
          placeholder="解決メモ（任意）"
          value={note}
        ...
        <div className="flex gap-3 mt-4 justify-end">
          <button
            onClick={onCancel}
            className="px-4 py-2 text-sm text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded transition-colors"
          >
            キャンセル
          </button>
          <button
            onClick={() => onConfirm(note)}
            className="px-4 py-2 text-sm text-white bg-[#e8002d] hover:bg-[#c0001f] rounded transition-colors"
          >
            クローズ実行
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg p-6 w-full max-w-sm shadow-xl">
        ...
        <input
          className="w-full bg-[#070d19] border border-[#1e2d42] rounded text-[#e2e8f4] text-sm p-2 focus:outline-none focus:border-[#e8002d]/50"
          placeholder="タグ名を入力..."
          value={tag}
        ...
        />
        <div className="flex gap-3 mt-4 justify-end">
          <button onClick={onCancel} className="px-4 py-2 text-sm text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded transition-colors">
            キャンセル
          </button>
          <button
            onClick={() => tag.trim() && onConfirm(tag.trim())}
            className="px-4 py-2 text-sm text-white bg-[#1a6bff] hover:bg-[#0044cc] rounded transition-colors"
          >
            追加
          </button>
        </div>
...
export default function TriagePage() {
  ...
  return (
    <div className="flex h-screen bg-[#070d19] overflow-hidden">
      ...
      <aside className="w-56 flex-shrink-0 bg-[#0d1220] border-r border-[#1e2d42] flex flex-col overflow-hidden">
        <div className="p-4 border-b border-[#1e2d42]">
          ...
          <button
            ...
            className="w-full flex items-center gap-1.5 px-3 py-1.5 rounded text-xs text-[#7d92b0] border border-[#1e2d42] hover:border-[#7d92b0]/40 hover:text-[#e2e8f4] transition-colors"
          >
            ...
            return (
              <div key={preset.id} className="group flex items-center gap-1">
                <button
                  ...
                  className="flex-1 text-left px-3 py-2 rounded text-xs text-[#7d92b0] hover:bg-[#19253d] hover:text-[#e2e8f4] transition-colors truncate"
                >
                  {preset.name}
                </button>
                {!isDefault && (
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* ── Page Header ────────────────────────────────────────────────── */}
        <div className="bg-[#0d1220] border-b border-[#1e2d42] px-6 py-4 flex-shrink-0">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 rounded bg-gradient-to-br from-[#e8002d] to-[#a80020] flex items-center justify-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
            ...
            <div className="relative lg:col-span-2">
              ...
              <input
                className="w-full bg-[#070d19] border border-[#1e2d42] rounded pl-8 pr-3 py-1.5 text-sm text-[#e2e8f4] placeholder:text-[#3d5068] focus:outline-none focus:border-[#e8002d]/50"
            ...
            {/* Agent */}
            <select
              className="bg-[#070d19] border border-[#1e2d42] rounded px-3 py-1.5 text-sm text-[#e2e8f4] focus:outline-none focus:border-[#e8002d]/50"
              value={filters.agent}
            ...
            <div className="relative">
              ...
              <input
                type="date"
                className="w-full bg-[#070d19] border border-[#1e2d42] rounded pl-8 pr-3 py-1.5 text-sm text-[#e2e8f4] focus:outline-none focus:border-[#e8002d]/50"
        ...
        {/* ── Sticky Action Bar ─────────────────────────────────────────── */}
        {selected.size > 0 && (
          <div className="flex-shrink-0 bg-[#0d1220] border-b border-[#e8002d]/30 px-6 py-2 flex items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium bg-[#1a6bff]/20 text-[#1a6bff] border border-[#1a6bff]/30 hover:bg-[#1a6bff]/30 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={batchMutation.isPending}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium bg-slate-700/50 text-slate-300 border border-slate-600/30 hover:bg-slate-700 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={batchMutation.isPending}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium bg-orange-900/30 text-orange-400 border border-orange-700/30 hover:bg-orange-900/50 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={batchMutation.isPending}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium bg-purple-900/30 text-purple-400 border border-purple-700/30 hover:bg-purple-900/50 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={batchMutation.isPending}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium bg-yellow-900/30 text-yellow-400 border border-yellow-700/30 hover:bg-yellow-900/50 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-medium text-[#7d92b0] border border-[#1e2d42] hover:text-[#e2e8f4] transition-colors"
              >
                        ...
                        {alert.tags && alert.tags.length > 0 && (
                          <div className="flex gap-1 mt-0.5 flex-wrap">
                            {alert.tags.slice(0, 3).map(tag => (
                              <span key={tag} className="px-1.5 py-0 rounded text-[9px] bg-purple-900/40 text-purple-400 border border-purple-700/20">
                                {tag}
                              </span>
                            ))}
                          </div>
        ...
        {/* ── Pagination ────────────────────────────────────────────────── */}
        <div className="flex-shrink-0 bg-[#0d1220] border-t border-[#1e2d42] px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page <= 1}
              className="p-1.5 rounded border border-[#1e2d42] text-[#7d92b0] hover:text-[#e2e8f4] hover:border-[#7d92b0]/40 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
            >
