    ...
    <div className="min-h-screen bg-[#070d19] p-6">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="flex items-center gap-1.5">
              ...
              <input
                ...
                className="text-xs border border-[#1e2d42] rounded-lg px-2 py-1.5 bg-[#0a111e] text-[#e2e8f4] focus:outline-hidden focus:border-[#e8002d]"
              />
            </div>
            <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-3 mb-4 flex-wrap">
        ...
        <select
          ...
          className="text-sm border border-[#1e2d42] rounded-lg px-3 py-2 bg-[#0d1220] text-[#7d92b0] focus:outline-hidden focus:border-[#e8002d]"
        >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 text-sm border border-[#1e2d42] rounded-lg bg-[#0d1220] text-white placeholder-[#3d5068] w-56 focus:outline-hidden focus:border-[#e8002d]"
          />
        </div>
        ...
        <button
          onClick={() => refetch()}
          disabled={isLoading}
          className="flex items-center gap-1.5 px-3 py-2 text-sm text-[#7d92b0] bg-[#0d1220] border border-[#1e2d42] rounded-lg hover:bg-[#1e2d42] transition-colors disabled:opacity-50"
        >
        ...
        <div className="flex items-center gap-1 ml-auto">
          <button
            ...
            className="p-1.5 text-[#7d92b0] bg-[#0d1220] border border-[#1e2d42] rounded-sm hover:bg-[#1e2d42] transition-colors"
            title="ズームイン"
          >
          ...
          <button
            ...
            className={`px-2 py-1.5 text-xs border rounded-sm transition-colors ${
              showLegend
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="relative bg-[#0d1220] border border-[#1e2d42] rounded-xl overflow-hidden"
            ...
            {tooltip.visible && (
              <div
                className="absolute z-20 pointer-events-none px-2.5 py-1.5 text-xs text-white bg-[#161f33] border border-[#1e2d42] rounded-lg shadow-xl max-w-[300px]"
          ...
          {clusters.length > 0 && (
            <div className="mt-4">
              <h2 className="text-sm font-semibold text-[#7d92b0] mb-2 uppercase tracking-wide flex items-center gap-2">
                クラスター一覧
                <span className="text-xs bg-[#1e2d42] text-[#7d92b0] px-1.5 py-0.5 rounded-sm">{clusters.length}</span>
                          ...
                          {clusterAlerts.map(alert => {
                            ...
                            return (
                              <button
                                ...
                                className="w-full flex items-center gap-2 py-1.5 px-2 rounded-sm hover:bg-[#1e2d42] transition-colors text-left group"
                              >
                                <div
            ...
            <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-4 space-y-4 sticky top-4">
              <div className="flex items-start justify-between gap-2">
                ...
                <button
                  ...
                  className="text-[#7d92b0] hover:text-white transition-colors shrink-0 text-lg leading-none"
                >
                  ×
                </button>
              </div>
              ...
              {selectedAlert.ai_mitre_tags && selectedAlert.ai_mitre_tags.length > 0 && (
                <div className="flex flex-wrap gap-1">
                  {selectedAlert.ai_mitre_tags.slice(0, 4).map(tag => (
                    <span key={tag} className="text-[10px] bg-[#161f33] border border-[#1e2d42] text-[#7d92b0] px-1.5 py-0.5 rounded-sm">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <Link
                ...
                className="block w-full text-center py-2 text-xs font-medium text-white bg-[#e8002d] rounded-lg hover:bg-[#c8001e] transition-colors"
              >
                アラート詳細を見る →
              </Link>
            </div>
