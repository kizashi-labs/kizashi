...
function OSBadge({ os }: { os: OSType }) {
  ...
  return (
    <span className={`inline-flex items-center shrink-0 text-[10px] font-bold leading-none px-1.5 py-0.5 rounded border ${cfg.cls}`}>
      {cfg.label}
    </span>
  )
}
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg w-full max-w-md shadow-2xl">
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <div className="bg-[#070d19] border border-[#1e2d42] rounded p-3 max-h-32 overflow-y-auto space-y-1">
            {agents.map(a => (
          ...
          {requireText && (
            <div>
              ...
              <input
                ...
                className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-white font-mono text-sm focus:outline-none focus:border-[#e8002d]"
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-[#1e2d42]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={handleExport}
            className="flex items-center gap-1.5 text-xs text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded px-2 py-1 hover:border-[#7d92b0]/40">
      ...
      <div className="divide-y divide-[#1e2d42] max-h-48 overflow-y-auto">
        {results.map(r => (
          <div key={r.agent_id} className="flex items-center gap-3 px-5 py-2.5">
            {r.status === 'success' && <CheckCircle2 className="w-4 h-4 text-green-400 flex-shrink-0" />}
            {r.status === 'failed'  && <XCircle      className="w-4 h-4 text-[#e8002d] flex-shrink-0" />}
            {r.status === 'pending' && <Clock        className="w-4 h-4 text-yellow-400 flex-shrink-0" />}
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="w-1/3 bg-[#0d1220] border border-[#1e2d42] rounded-lg flex flex-col">
          ...
          <div className="px-4 pt-4 pb-3 border-b border-[#1e2d42] space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <select
                ...
                className="bg-[#070d19] border border-[#1e2d42] rounded px-2 py-1.5 text-xs text-[#e2e8f4] focus:outline-none focus:border-blue-500"
              >
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-[#1e2d42]">
            ...
            {selectedCount > 0 && (
              <span className="text-xs font-bold px-2 py-0.5 rounded bg-[#e8002d]/20 text-[#e8002d] border border-[#e8002d]/30">
                {selectedCount}台選択中
              </span>
            )}
          </div>
              ...
              paged.map(agent => (
                <label key={agent.id}
                  ...
                  {selectedIds.has(agent.id)
                    ...
                    : <Square className="w-4 h-4 text-[#3d5068] flex-shrink-0 group-hover:text-[#7d92b0]" />
                  }
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between px-4 py-2.5 border-t border-[#1e2d42]">
              <button onClick={() => setPage(p => Math.max(1, p - 1))} disabled={page === 1}
                className="p-1 rounded text-[#7d92b0] hover:text-white disabled:opacity-30">
              ...
              <div className="space-y-5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {COMMAND_TEMPLATES.map(t => (
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 rounded bg-[#070d19] border border-[#1e2d42]
                                   hover:border-blue-500/50 hover:bg-blue-900/10 text-[#e2e8f4] text-sm
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="コマンドを入力..."
                    className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-white text-sm font-mono
                               focus:outline-none focus:border-blue-500 resize-none placeholder-[#3d5068]"
                  />
                  <button
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <select
                      ...
                      className="flex-1 bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-[#e2e8f4] focus:outline-none focus:border-blue-500"
                    >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-[#e2e8f4] focus:outline-none focus:border-blue-500"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-white font-mono
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#070d19] border border-[#1e2d42] rounded-lg p-4 space-y-3">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0d1220] border border-[#1e2d42] rounded px-3 py-2 text-white font-mono text-sm
                               focus:outline-none focus:border-[#e8002d] placeholder-[#3d5068]"
                  />
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded bg-[#e8002d] hover:bg-[#c0001f]
