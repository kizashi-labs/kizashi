            ...
            <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 border-b border-[#1e2d42]">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs text-[#7d92b0] hover:text-white px-2 py-1 rounded hover:bg-[#1e2d42] transition-colors"
                >
                ...
                {tags.map(tag => (
                  <div key={tag.id} className="flex items-center gap-1 group">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 transition-opacity p-0.5 rounded hover:bg-[#1e2d42] text-[#7d92b0] hover:text-[#e8002d]"
                    >
                    ...
                    <tbody className="divide-y divide-[#1e2d42]">
                      {taggedEndpoints.map(agent => (
                        <tr key={agent.id} className="hover:bg-[#0a1628] transition-colors">
                          ...
                          <td className="px-4 py-3">
                            <span className={`text-[11px] px-2 py-0.5 rounded border font-medium ${OS_COLORS[agent.os] ?? 'bg-[#1e2d42] text-[#7d92b0] border-[#1e2d42]'}`}>
                              {agent.os}
                            </span>
                          </td>
                          <td className="px-4 py-3">
                          ...
                          <td className="px-4 py-3">
                            <button
                              ...
                              className="flex items-center gap-1 text-xs text-[#7d92b0] hover:text-[#e8002d] transition-colors px-2 py-1 rounded hover:bg-[#1e2d42] disabled:opacity-50"
                            >
          ...
          <div className="p-5">
            ...
            {wizResult && (
              <div className="space-y-4">
                ...
                <button onClick={resetWizard} className="px-4 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white text-sm rounded transition-colors">
                  新しい操作を開始
                </button>
              </div>
            )}
              ...
              <>
                      ...
                      {filteredAgents.map(agent => (
                        ...
                        >
                          {wizSelected.includes(agent.id)
                            ? <CheckSquare className="w-4 h-4 text-[#e8002d] flex-shrink-0" />
                            : <Square className="w-4 h-4 text-[#3d5068] flex-shrink-0" />}
                          <Monitor className="w-3.5 h-3.5 text-[#3d5068] flex-shrink-0" />
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className={`text-[10px] px-1.5 py-0.5 rounded border font-medium ${OS_COLORS[agent.os] ?? ''}`}>{agent.os}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                {wizStep === 2 && (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2 justify-end">
                      <button onClick={() => setWizStep(1)} className="px-4 py-2 text-xs text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded hover:border-[#7d92b0]/40 transition-colors">戻る</button>
                      <button onClick={() => setWizStep(3)} className="px-4 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white text-sm rounded transition-colors">次へ</button>
                    </div>
                  </div>
                )}
                ...
                {wizStep === 3 && (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2 justify-end">
                      <button onClick={() => setWizStep(2)} className="px-4 py-2 text-xs text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded hover:border-[#7d92b0]/40 transition-colors">戻る</button>
                      <button
                ...
                {wizStep === 4 && (
                  <div className="space-y-4">
                      ...
                      <div className="border-t border-[#1e2d42] pt-3">
                        <div className="flex flex-wrap gap-1 max-h-24 overflow-y-auto">
                          {wizSelected.map(id => {
                            ...
                            return a ? (
                              <span key={id} className="text-[11px] px-2 py-0.5 rounded bg-[#1e2d42] text-[#7d92b0] border border-[#1e2d42]">{a.hostname}</span>
                            ) : null
                          })}
                        </div>
                      </div>
                    ...
                    <div className="flex gap-2 justify-end">
                      <button onClick={() => setWizStep(3)} className="px-4 py-2 text-xs text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded hover:border-[#7d92b0]/40 transition-colors">戻る</button>
                      <button
                        onClick={handleBulkExecute}
                        disabled={bulkMutation.isPending}
                        className="px-5 py-2 bg-[#e8002d] hover:bg-[#c8001f] text-white text-sm font-medium rounded transition-colors disabled:opacity-50"
                      >
        ...
        <Modal title="タグ作成" onClose={() => setShowCreate(false)}>
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-end pt-2">
              <button onClick={() => setShowCreate(false)} className="px-4 py-2 text-xs text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded hover:border-[#7d92b0]/40 transition-colors">
                キャンセル
              </button>
              <button
      ...
      {deleteTag && (
        <Modal title="タグ削除" onClose={() => setDeleteTag(null)}>
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-end">
              <button onClick={() => setDeleteTag(null)} className="px-4 py-2 text-xs text-[#7d92b0] hover:text-white border border-[#1e2d42] rounded hover:border-[#7d92b0]/40 transition-colors">
                キャンセル
              </button>
              <button
