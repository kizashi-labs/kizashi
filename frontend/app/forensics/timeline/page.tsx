  ...
  return (
    <div className="flex gap-4 group">
      ...
      <div className="flex flex-col items-center shrink-0" style={{ width: 24 }}>
        <div className={`w-3 h-3 rounded-full ${cfg.dotColor} border-2 border-[#0d1220] z-10 shrink-0 mt-4`} />
      ...
      `}>
        ...
        {expanded && (
          <div className="border-t border-[#1e2d42] px-4 py-3">
            ...
            <pre className="text-xs text-[#7d92b0] font-mono bg-[#080c14] rounded-sm p-3 overflow-x-auto">
  ...
  return (
    <div className="min-h-full bg-[#080c14] p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-linear-to-br from-[#4d8fff]/20 to-[#7b61ff]/20 border border-[#4d8fff]/20 flex items-center justify-center">
        ...
        {filteredEvents.length > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#19253d] border border-[#1e2d42] text-sm text-[#7d92b0] hover:text-[#e2e8f4] hover:border-[#2a3d5a] transition-colors"
          >
        ...
        <div className="flex flex-wrap gap-4 items-end">
          ...
          <div className="flex flex-col gap-1.5 min-w-[200px]">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-[#080c14] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-[#e2e8f4] appearance-none cursor-pointer focus:outline-hidden focus:border-[#4d8fff]/50 transition-colors pr-8"
              >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="bg-[#080c14] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-[#e2e8f4] focus:outline-hidden focus:border-[#4d8fff]/50 transition-colors"
            />
          </div>
            ...
            <div className="flex gap-1.5">
              {(['1h', '6h', '24h', '7d'] as const).map(p => (
                <button
                  ...
                  className="px-2.5 py-2 text-xs rounded-lg bg-[#080c14] border border-[#1e2d42] text-[#7d92b0] hover:text-[#e2e8f4] hover:border-[#2a3d5a] transition-colors"
                >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#4d8fff] text-white text-sm font-medium hover:bg-[#3d7fff] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isFetching
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex-1 min-w-[200px] relative">
              ...
              <input
                ...
                className="w-full bg-[#080c14] border border-[#1e2d42] rounded-lg pl-8 pr-3 py-1.5 text-sm text-[#e2e8f4] placeholder-[#3d5068] focus:outline-hidden focus:border-[#4d8fff]/50 transition-colors"
              />
            </div>
      ...
      {!queryParams ? (
        ...
        <div>
          ...
          <div className="flex-1 min-w-0">
            {/* Agent Info Banner */}
            {selectedAgent && (
              <div className="flex items-center gap-3 px-4 py-2.5 mb-4 rounded-lg bg-[#0d1220] border border-[#1e2d42]">
                ...
                {useMockEvents && (
                  <span className="text-[10px] bg-yellow-500/10 text-yellow-500 border border-yellow-500/20 px-1.5 py-0.5 rounded-sm">モックデータ</span>
                )}
              </div>
            )}
