    ...
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-1 bg-[#111827] border border-[#1e2d42] rounded-lg px-4 py-2.5 text-sm text-[#e2e8f4] placeholder-[#5a6a7a] focus:outline-hidden focus:border-blue-500/60 transition-colors"
        />
        <button
          type="submit"
          disabled={!input.trim() || mutation.isPending}
          className="px-5 py-2.5 bg-blue-600 text-white text-sm rounded-lg font-medium hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
