            ...
            {HUNT_TEMPLATES.map((tmpl) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <div className="p-1 bg-[#161f33] rounded group-hover:bg-[#1e2d42] transition-colors">{tmpl.icon}</div>
          ...
          <form onSubmit={handleSearch} className="flex flex-col flex-1 p-4 gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                className="w-full px-3 py-2.5 font-mono text-sm bg-gray-950 border border-[#1e2d42] rounded-lg text-green-300 placeholder-[#2a3a52] focus:outline-none focus:border-blue-500 resize-none leading-relaxed"
              />
            </div>
                ...
                <div className="mt-3 space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-[#080c14] border border-[#1e2d42] rounded-lg text-xs text-[#e2e8f4] placeholder-[#4a5568] focus:outline-none focus:border-blue-500"
                    />
                  </div>
                  <div>
                    ...
                    <>
                      <div>
                        ...
                        <input type="datetime-local" value={startTime} onChange={(e) => setStartTime(e.target.value)}
                          className="w-full px-3 py-2 bg-[#080c14] border border-[#1e2d42] rounded-lg text-xs text-[#e2e8f4] focus:outline-none focus:border-blue-500" />
                      </div>
                      <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                  {eventTypePills.map(([type, count]) => (
                    <div key={type} className="bg-[#111827] border border-[#1e2d42] rounded-lg p-3">
                      <div className={`text-xs px-2 py-0.5 rounded border inline-block mb-2 ${EVENT_TYPE_COLORS[type] ?? 'bg-[#161f33] text-[#7d92b0] border-[#1e2d42]'}`}>
                        {type}
                      </div>
              ...
              {savedLoading ? (
                ...
                savedHunts.map((hunt) => (
                  ...
                  >
                        ...
                        {canWrite && (confirmDeleteId === hunt.id ? (
                          <div className="flex gap-0.5">
                            ...
                            <button
                              ...
                              className="px-1.5 py-0.5 bg-[#1e2d42] hover:bg-[#2a3a52] rounded text-xs text-[#7d92b0]"
                            >
                              取消
                            </button>
                          </div>
                    ...
                    {hunt.params.query && (
                      <div className="font-mono text-xs text-[#4a5568] bg-[#080c14] rounded px-2 py-1 truncate mb-1.5">
                        {hunt.params.query}
                      </div>
                    )}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 bg-[#080c14] border border-[#1e2d42] rounded-lg text-sm text-[#e2e8f4] placeholder-[#7d92b0] focus:outline-none focus:border-blue-500 resize-none"
                />
              </div>
              <div className="text-xs text-[#7d92b0] bg-[#080c14] rounded p-2 font-mono">
