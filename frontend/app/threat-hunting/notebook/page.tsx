    ...
    <div className="space-y-3">
      <div className="flex gap-2">
        <textarea
          ...
          rows={4}
          className="flex-1 bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-[#c8d6e8] text-xs font-mono focus:outline-none focus:border-[#e8002d]/50 resize-y"
        ...
        <div className="flex flex-col gap-2 flex-shrink-0">
          ...
          <button
            onClick={onRun}
            className="flex items-center gap-1 px-3 py-1.5 rounded bg-[#e8002d] text-white text-xs hover:bg-[#c00025] transition-colors"
          >
      ...
      {cell.results && (
        <div className="overflow-x-auto rounded border border-[#1e2d42]">
  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-2 py-1.5 text-sm text-white focus:outline-none focus:border-[#e8002d]/50"
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-2 py-1.5 text-xs font-mono text-white focus:outline-none focus:border-[#e8002d]/50"
            placeholder="a1b2c3..."
          />
        </div>
      </div>
      <div>
        ...
        <div className="bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-xs text-[#c8d6e8]">
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-6 w-full max-w-md shadow-2xl">
        <div className="flex items-center justify-between mb-5">
          ...
          <button onClick={onClose} className="p-1.5 rounded text-[#7d92b0] hover:text-white hover:bg-[#1e2d42] transition-colors">
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            disabled={!title}
            className="flex-1 py-2 rounded bg-[#e8002d] text-white text-sm font-medium hover:bg-[#c00025] transition-colors disabled:opacity-40"
          >
            作成
          </button>
        </div>
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-6 w-full max-w-sm shadow-2xl">
        ...
        <div className="space-y-2 mb-4">
          {users.map(u => (
            <label key={u} className="flex items-center gap-3 p-2 rounded hover:bg-[#1e2d42] cursor-pointer">
              <input
                type="checkbox"
              ...
              />
              <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#1a6bff] to-[#0044cc] flex items-center justify-center text-[9px] font-bold text-white">
                {u[0]}
              </div>
        ...
        <button
          onClick={onClose}
          className="w-full py-2 rounded bg-[#e8002d] text-white text-sm font-medium hover:bg-[#c00025] transition-colors"
        >
    ...
    <div className="min-h-screen bg-[#070d19] text-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="bg-[#0d1220] border border-[#1e2d42] rounded-xl p-16 flex flex-col items-center gap-4 text-center">
          ...
          <button
            onClick={() => setShowNewModal(true)}
            className="mt-2 flex items-center gap-2 px-4 py-2 rounded bg-[#e8002d] text-white hover:bg-[#c00025] text-sm font-medium transition-colors"
          >
            <Plus className="w-4 h-4" /> 新規ノートブック
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#070d19] text-white flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 flex-shrink-0 border-r border-[#1e2d42] overflow-y-auto">
              ...
              <div key={nb.id} className="relative group">
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <span className={`px-1.5 py-0.5 rounded border text-[10px] font-medium ${STATUS_STYLES[nb.status]}`}>
                      {STATUS_LABELS[nb.status]}
                    </span>
                    {nb.verdict && (
                      <span className={`px-1.5 py-0.5 rounded border text-[10px] ${VERDICT_STYLES[nb.verdict]}`}>
                ...
                <button
                  ...
                  className="absolute top-2 right-2 p-1 rounded text-[#3d5068] hover:text-[#e8002d] hover:bg-[#e8002d]/10 opacity-0 group-hover:opacity-100 transition-all"
                  title="削除"
                >
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                {editingTitle ? (
                  <input
                    ...
                    autoFocus
                    className="flex-1 bg-transparent border-b border-[#e8002d]/50 text-white text-lg font-bold focus:outline-none"
                  />
                ) : (
                  <h2
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className={`px-2 py-1 rounded border text-xs bg-transparent focus:outline-none ${STATUS_STYLES[selected.status]}`}
                  >
              ...
              {[
                ...
                <div key={field}>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-[#070d19] border border-[#1e2d42] rounded px-3 py-2 text-sm text-[#c8d6e8] focus:outline-none focus:border-[#e8002d]/50 resize-y"
                  />
                </div>
              ))}
            </div>
              ...
              <div key={cell.id}>
                <div className="bg-[#0d1220] border border-[#1e2d42] rounded-lg overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 border-b border-[#1e2d42] bg-[#0a1018]">
                    ...
                    <span className={`px-2 py-0.5 rounded border text-[10px] font-medium ${CELL_TYPE_STYLES[cell.type]}`}>
                  ...
                  {selected.recommendations.map((rec, i) => (
                    <div key={i} className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="flex-1 bg-[#070d19] border border-[#1e2d42] rounded px-2 py-1 text-xs text-[#c8d6e8] focus:outline-none focus:border-[#e8002d]/50"
                      />
                      <button
