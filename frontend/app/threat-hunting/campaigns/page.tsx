    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-5 border-b border-[#1e2d42]">
        ...
        <div className="flex flex-wrap gap-2">
          <span className={`px-2 py-0.5 rounded text-xs font-medium ${tc}`}>{campaign.tactic}</span>
          {campaign.techniques.map(t => (
            <span key={t} className="px-2 py-0.5 bg-[#070d19] border border-[#1e2d42] text-[#7d92b0] rounded text-xs font-mono">{t}</span>
          ))}
        </div>
      </div>
                  ...
                  <div key={f.id} className="relative flex items-start gap-3">
                    ...
                    <div className="ml-2 flex-1">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <span className={`px-1.5 py-0.5 rounded text-xs font-medium ${sv.cls}`}>{sv.label}</span>
                      </div>
        ...
        <div>
          ...
          {showNoteInput && (
            <div className="mt-2">
              <textarea
                rows={3}
                className="w-full bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-[#e8002d] resize-none"
                placeholder="メモを入力..."
                value={note}
              ...
              <div className="flex justify-end mt-1">
                <button
                  ...
                  className="px-3 py-1 bg-[#e8002d] text-white text-xs rounded hover:bg-red-600"
                >
                  保存
                </button>
              </div>
      ...
      <div className="flex gap-4" style={{ height: 'calc(100vh - 260px)' }}>
        ...
        <div className="w-[35%] bg-[#0d1220] border border-[#1e2d42] rounded-lg overflow-hidden flex flex-col">
          <div className="p-4 border-b border-[#1e2d42] flex items-center justify-between">
            ...
            <button className="flex items-center gap-1 px-2.5 py-1 bg-[#e8002d] text-white rounded text-xs hover:bg-red-600">
              <Plus size={11} />
              新規
            </button>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <span className={`px-1.5 py-0.5 rounded text-xs font-medium ${tc}`}>{c.tactic}</span>
