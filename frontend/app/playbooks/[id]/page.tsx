...
function StepStatusIcon({ status }: { status: string }) {
  if (status === 'success') return <CheckCircle2 size={16} className="text-green-400 flex-shrink-0" />
  if (status === 'failed') return <XCircle size={16} className="text-red-400 flex-shrink-0" />
  return <Loader2 size={16} className="text-blue-400 flex-shrink-0 animate-spin" />
}
      ...
      <div className="relative bg-[#0d1220] border border-[#1e2d42] rounded-2xl w-full max-w-md mx-4 shadow-2xl">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none bg-[#070d19] border border-[#1e2d42] rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-[#e8002d]/60 transition-colors pr-8"
              >
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-[#1e2d42]">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#e8002d] hover:bg-[#c0001f] disabled:opacity-50
  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end">
      ...
      <div className="relative bg-[#0d1220] border-l border-[#1e2d42] w-full max-w-lg h-full flex flex-col shadow-2xl">
        ...
        {/* Meta info */}
        <div className="px-5 py-3 border-b border-[#1e2d42] flex-shrink-0 space-y-1.5">
        ...
        .map((step, idx) => {
          ...
          return (
            ...
            >
              ...
              >
                {/* Step number circle */}
                <div className="w-8 h-8 rounded-full bg-[#161f33] border border-[#1e2d42] flex items-center
                                justify-center text-sm font-bold text-[#7d92b0] flex-shrink-0">
                  {idx + 1}
                </div>

                {/* Action type badge */}
                <div className={`flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-lg border ${meta.bg} ${meta.color} flex-shrink-0`}>
                  {meta.icon}
                  {meta.label}
                </div>
                ...
                {/* Expand toggle */}
                <div className="text-[#7d92b0] flex-shrink-0">
                    ...
                    <div>
                      ...
                      <div className="space-y-1.5">
                        {paramEntries.map(([k, v]) => (
                          <div key={k} className="flex items-start justify-between gap-4">
                            <span className="text-xs text-[#7d92b0] font-mono flex-shrink-0">{k}</span>
            ...
            >
              ...
              <td className="px-5 py-3 text-right">
                <button
                  ...
                  className="inline-flex items-center gap-1 text-xs text-[#7d92b0] hover:text-white
                             transition-colors px-2.5 py-1 rounded-lg hover:bg-[#161f33] border border-transparent
                             hover:border-[#1e2d42]"
                >
                  詳細
    ...
    <div className="min-h-screen bg-[#070d19]">
      <div className="p-6 max-w-6xl mx-auto space-y-5">
        ...
        <div className="flex items-start gap-4">
          ...
          <Link
            href="/playbooks"
            className="text-[#7d92b0] hover:text-white transition-colors mt-1 flex-shrink-0"
            title="プレイブック一覧に戻る"
          >
            <ArrowLeft size={20} />
          </Link>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              <Workflow size={20} className="text-purple-400 flex-shrink-0" />
              <h1 className="text-2xl font-bold text-white truncate">{playbook.name}</h1>

              {/* Status badge */}
              {playbook.enabled ? (
                <span className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full
                                 bg-green-900/40 text-green-300 border border-green-700/50 flex-shrink-0">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-400 inline-block" />
                  有効
                </span>
              ) : (
                <span className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full
                                 bg-[#161f33] text-[#7d92b0] border border-[#1e2d42] flex-shrink-0">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <Link
              ...
              className="flex items-center gap-1.5 text-sm text-[#7d92b0] hover:text-white border
                         border-[#1e2d42] hover:border-[#2e3d52] bg-[#0d1220] px-3.5 py-2 rounded-lg transition-colors"
            >
              <Pencil size={14} />
              編集
            </Link>
            <button
              ...
              className="flex items-center gap-1.5 text-sm font-medium text-white bg-[#e8002d]
